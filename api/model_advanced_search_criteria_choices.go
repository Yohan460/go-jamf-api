...
// checks if the AdvancedSearchCriteriaChoices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvancedSearchCriteriaChoices{}
...
func (o AdvancedSearchCriteriaChoices) ToMap() (map[string]interface{}, error) {
