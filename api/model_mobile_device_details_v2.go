...
// checks if the MobileDeviceDetailsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MobileDeviceDetailsV2{}
...
func (o MobileDeviceDetailsV2) ToMap() (map[string]interface{}, error) {
