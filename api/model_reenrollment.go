...
type _Reenrollment Reenrollment
...
func (o *Reenrollment) UnmarshalJSON(data []byte) (err error) {
	...
	varReenrollment := _Reenrollment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReenrollment)

	if err != nil {
		return err
	}

	*o = Reenrollment(varReenrollment)
