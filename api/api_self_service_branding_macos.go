...
func (r SelfServiceBrandingMacosAPIV1SelfServiceBrandingMacosGetRequest) Page(page int64) SelfServiceBrandingMacosAPIV1SelfServiceBrandingMacosGetRequest {
	r.page = &page
	return r
}

func (r SelfServiceBrandingMacosAPIV1SelfServiceBrandingMacosGetRequest) PageSize(pageSize int64) SelfServiceBrandingMacosAPIV1SelfServiceBrandingMacosGetRequest {
	r.pageSize = &pageSize
	return r
}
