...
// checks if the WatchOsDetailsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatchOsDetailsV2{}
...
func (o WatchOsDetailsV2) MarshalJSON() ([]byte, error) {
...
func (o WatchOsDetailsV2) ToMap() (map[string]interface{}, error) {
...
type NullableWatchOsDetailsV2 struct {
	value *WatchOsDetailsV2
	isSet bool
}

func (v NullableWatchOsDetailsV2) Get() *WatchOsDetailsV2 {
	return v.value
}

func (v *NullableWatchOsDetailsV2) Set(val *WatchOsDetailsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableWatchOsDetailsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableWatchOsDetailsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatchOsDetailsV2(val *WatchOsDetailsV2) *NullableWatchOsDetailsV2 {
	return &NullableWatchOsDetailsV2{value: val, isSet: true}
}

func (v NullableWatchOsDetailsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatchOsDetailsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
