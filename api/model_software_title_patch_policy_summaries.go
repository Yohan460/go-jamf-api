...
func NewSoftwareTitlePatchPolicySummaries() *SoftwareTitlePatchPolicySummaries {
	this := SoftwareTitlePatchPolicySummaries{}
	return &this
}
...
// SetResults gets a reference to the given []PatchPolicySummary and assigns it to the Results field.
func (o *SoftwareTitlePatchPolicySummaries) SetResults(v []PatchPolicySummary) {
	o.Results = v
}

func (o SoftwareTitlePatchPolicySummaries) MarshalJSON() ([]byte, error) {
...
type NullableSoftwareTitlePatchPolicySummaries struct {
	value *SoftwareTitlePatchPolicySummaries
	isSet bool
}

func (v NullableSoftwareTitlePatchPolicySummaries) Get() *SoftwareTitlePatchPolicySummaries {
	return v.value
}

func (v *NullableSoftwareTitlePatchPolicySummaries) Set(val *SoftwareTitlePatchPolicySummaries) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareTitlePatchPolicySummaries) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareTitlePatchPolicySummaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareTitlePatchPolicySummaries(val *SoftwareTitlePatchPolicySummaries) *NullableSoftwareTitlePatchPolicySummaries {
	return &NullableSoftwareTitlePatchPolicySummaries{value: val, isSet: true}
}

func (v NullableSoftwareTitlePatchPolicySummaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareTitlePatchPolicySummaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
