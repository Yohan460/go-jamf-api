...
type _VolumePurchasingSubscription VolumePurchasingSubscription
...
func (o *VolumePurchasingSubscription) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumePurchasingSubscription := _VolumePurchasingSubscription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVolumePurchasingSubscription)

	if err != nil {
		return err
	}

	*o = VolumePurchasingSubscription(varVolumePurchasingSubscription)
