...
**PersonalText** | Pointer to **string** | **Deprecated as of 11.25.** This field always returns empty string in GET responses and ignores any input values in PUT requests.  | [optional] [readonly] [default to ""]
**PersonalButton** | Pointer to **string** | **Deprecated as of 11.25.** This field always returns empty string in GET responses and ignores any input values in PUT requests.  | [optional] [readonly] [default to ""]
**PersonalProfileName** | Pointer to **string** | **Deprecated as of 11.25.** This field always returns empty string in GET responses and ignores any input values in PUT requests.  | [optional] [readonly] [default to ""]
**PersonalProfileDescription** | Pointer to **string** | **Deprecated as of 11.25.** This field always returns empty string in GET responses and ignores any input values in PUT requests.  | [optional] [readonly] [default to ""]
