...
`func (o *PutComputerPrestageV3) GetPrestageMinimumOsTargetVersionType() string`
...
`func (o *PutComputerPrestageV3) GetPrestageMinimumOsTargetVersionTypeOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetPrestageMinimumOsTargetVersionType(v string)`
...
`func (o *PutComputerPrestageV3) HasPrestageMinimumOsTargetVersionType() bool`

HasPrestageMinimumOsTargetVersionType returns a boolean if a field has been set.

### GetMinimumOsSpecificVersion

`func (o *PutComputerPrestageV3) GetMinimumOsSpecificVersion() string`
...
`func (o *PutComputerPrestageV3) GetMinimumOsSpecificVersionOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetPssoEnabled(v bool)`

SetPssoEnabled sets PssoEnabled field to given value.

### HasPssoEnabled

`func (o *PutComputerPrestageV3) HasPssoEnabled() bool`

HasPssoEnabled returns a boolean if a field has been set.

### GetPlatformSsoAppBundleId

`func (o *PutComputerPrestageV3) GetPlatformSsoAppBundleId() string`
...
`func (o *PutComputerPrestageV3) GetPlatformSsoAppBundleIdOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetPlatformSsoAppBundleId(v string)`

SetPlatformSsoAppBundleId sets PlatformSsoAppBundleId field to given value.

### HasPlatformSsoAppBundleId

`func (o *PutComputerPrestageV3) HasPlatformSsoAppBundleId() bool`

HasPlatformSsoAppBundleId returns a boolean if a field has been set.

### GetProfileUrl

`func (o *PutComputerPrestageV3) GetProfileUrl() string`

GetProfileUrl returns the ProfileUrl field if non-nil, zero value otherwise.

### GetProfileUrlOk

`func (o *PutComputerPrestageV3) GetProfileUrlOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetProfileUrl(v string)`

SetProfileUrl sets ProfileUrl field to given value.

### HasProfileUrl

`func (o *PutComputerPrestageV3) HasProfileUrl() bool`

HasProfileUrl returns a boolean if a field has been set.

### SetProfileUrlNil

`func (o *PutComputerPrestageV3) SetProfileUrlNil(b bool)`

 SetProfileUrlNil sets the value for ProfileUrl to be an explicit nil

### UnsetProfileUrl
`func (o *PutComputerPrestageV3) UnsetProfileUrl()`

UnsetProfileUrl ensures that no value is present for ProfileUrl, not even an explicit nil
### GetPssoConfigProfileId

`func (o *PutComputerPrestageV3) GetPssoConfigProfileId() string`

GetPssoConfigProfileId returns the PssoConfigProfileId field if non-nil, zero value otherwise.

### GetPssoConfigProfileIdOk

`func (o *PutComputerPrestageV3) GetPssoConfigProfileIdOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetManifestUrl(v string)`

SetManifestUrl sets ManifestUrl field to given value.

### HasManifestUrl

`func (o *PutComputerPrestageV3) HasManifestUrl() bool`

HasManifestUrl returns a boolean if a field has been set.

### SetManifestUrlNil

`func (o *PutComputerPrestageV3) SetManifestUrlNil(b bool)`

 SetManifestUrlNil sets the value for ManifestUrl to be an explicit nil

### UnsetManifestUrl
`func (o *PutComputerPrestageV3) UnsetManifestUrl()`

UnsetManifestUrl ensures that no value is present for ManifestUrl, not even an explicit nil
### GetAuthUrl

`func (o *PutComputerPrestageV3) GetAuthUrl() string`

GetAuthUrl returns the AuthUrl field if non-nil, zero value otherwise.

### GetAuthUrlOk

`func (o *PutComputerPrestageV3) GetAuthUrlOk() (*string, bool)`
...
`func (o *PutComputerPrestageV3) SetAuthUrl(v string)`

SetAuthUrl sets AuthUrl field to given value.

### HasAuthUrl

`func (o *PutComputerPrestageV3) HasAuthUrl() bool`

HasAuthUrl returns a boolean if a field has been set.

### SetAuthUrlNil

`func (o *PutComputerPrestageV3) SetAuthUrlNil(b bool)`

 SetAuthUrlNil sets the value for AuthUrl to be an explicit nil

### UnsetAuthUrl
`func (o *PutComputerPrestageV3) UnsetAuthUrl()`
