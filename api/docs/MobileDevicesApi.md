...
[**V2MobileDevicesIdErasePost**](MobileDevicesAPI.md#V2MobileDevicesIdErasePost) | **Post** /v2/mobile-devices/{id}/erase | Erase a Mobile Device 
...
[**V2MobileDevicesIdUnmanagePost**](MobileDevicesAPI.md#V2MobileDevicesIdUnmanagePost) | **Post** /v2/mobile-devices/{id}/unmanage | Unmanage a Mobile Device 
...
## V2MobileDevicesIdErasePost

> EraseDeviceMobileDeviceResponse V2MobileDevicesIdErasePost(ctx, id).EraseDeviceMobileDeviceRequest(eraseDeviceMobileDeviceRequest).Execute()
...
func main() {
	id := "id_example" // string | Id of the Mobile Device to erase
	eraseDeviceMobileDeviceRequest := *openapiclient.NewEraseDeviceMobileDeviceRequest() // EraseDeviceMobileDeviceRequest | Options for eraseDevice command (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.MobileDevicesAPI.V2MobileDevicesIdErasePost(context.Background(), id).EraseDeviceMobileDeviceRequest(eraseDeviceMobileDeviceRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `MobileDevicesAPI.V2MobileDevicesIdErasePost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `V2MobileDevicesIdErasePost`: EraseDeviceMobileDeviceResponse
	fmt.Fprintf(os.Stdout, "Response from `MobileDevicesAPI.V2MobileDevicesIdErasePost`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | Id of the Mobile Device to erase | 

### Other Parameters

Other parameters are passed through a pointer to a apiV2MobileDevicesIdErasePostRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **eraseDeviceMobileDeviceRequest** | [**EraseDeviceMobileDeviceRequest**](EraseDeviceMobileDeviceRequest.md) | Options for eraseDevice command | 

### Return type

[**EraseDeviceMobileDeviceResponse**](EraseDeviceMobileDeviceResponse.md)
...
## V2MobileDevicesIdUnmanagePost

> UnmanageMobileDeviceResponse V2MobileDevicesIdUnmanagePost(ctx, id).Execute()
...
func main() {
	id := "id_example" // string | Id of the mobile device to remove the MDM profile from

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.MobileDevicesAPI.V2MobileDevicesIdUnmanagePost(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `MobileDevicesAPI.V2MobileDevicesIdUnmanagePost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `V2MobileDevicesIdUnmanagePost`: UnmanageMobileDeviceResponse
	fmt.Fprintf(os.Stdout, "Response from `MobileDevicesAPI.V2MobileDevicesIdUnmanagePost`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | Id of the mobile device to remove the MDM profile from | 

### Other Parameters

Other parameters are passed through a pointer to a apiV2MobileDevicesIdUnmanagePostRequest struct via the builder pattern
...
[**UnmanageMobileDeviceResponse**](UnmanageMobileDeviceResponse.md)
