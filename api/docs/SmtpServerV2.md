...
**GoogleMailCredentials** | Pointer to [**SmtpGoogleMailCredentials**](SmtpGoogleMailCredentials.md) |  | [optional] 
...
### GetGoogleMailCredentials

`func (o *SmtpServerV2) GetGoogleMailCredentials() SmtpGoogleMailCredentials`

GetGoogleMailCredentials returns the GoogleMailCredentials field if non-nil, zero value otherwise.

### GetGoogleMailCredentialsOk

`func (o *SmtpServerV2) GetGoogleMailCredentialsOk() (*SmtpGoogleMailCredentials, bool)`

GetGoogleMailCredentialsOk returns a tuple with the GoogleMailCredentials field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetGoogleMailCredentials

`func (o *SmtpServerV2) SetGoogleMailCredentials(v SmtpGoogleMailCredentials)`

SetGoogleMailCredentials sets GoogleMailCredentials field to given value.

### HasGoogleMailCredentials
