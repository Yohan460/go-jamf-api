...
// checks if the SessionDetailsSearchResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionDetailsSearchResults{}
...
func (o SessionDetailsSearchResults) ToMap() (map[string]interface{}, error) {
