...
var _ MappedNullable = &PostComputerPrestageV3{}

// PostComputerPrestageV3 struct for PostComputerPrestageV3
...
func (o *PostComputerPrestageV3) SetProfileUrlNil() {
...
func (o *PostComputerPrestageV3) SetPssoConfigProfileIdNil() {
...
func (o *PostComputerPrestageV3) SetManifestUrlNil() {
...
func (o *PostComputerPrestageV3) SetAuthUrlNil() {
	o.AuthUrl.Set(nil)
}
...
func (o PostComputerPrestageV3) MarshalJSON() ([]byte, error) {
...
func (o PostComputerPrestageV3) ToMap() (map[string]interface{}, error) {
...
type NullablePostComputerPrestageV3 struct {
	value *PostComputerPrestageV3
	isSet bool
}

func (v NullablePostComputerPrestageV3) Get() *PostComputerPrestageV3 {
	return v.value
}

func (v *NullablePostComputerPrestageV3) Set(val *PostComputerPrestageV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePostComputerPrestageV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePostComputerPrestageV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostComputerPrestageV3(val *PostComputerPrestageV3) *NullablePostComputerPrestageV3 {
	return &NullablePostComputerPrestageV3{value: val, isSet: true}
}

func (v NullablePostComputerPrestageV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostComputerPrestageV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
