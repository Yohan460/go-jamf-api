...
// checks if the PutComputerPrestageV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutComputerPrestageV3{}

// PutComputerPrestageV3 struct for PutComputerPrestageV3
...
type _PutComputerPrestageV3 PutComputerPrestageV3
...
func (o *PutComputerPrestageV3) SetProfileUrlNil() {
...
func (o *PutComputerPrestageV3) SetPssoConfigProfileIdNil() {
...
func (o *PutComputerPrestageV3) SetManifestUrlNil() {
...
func (o *PutComputerPrestageV3) SetAuthUrlNil() {
	o.AuthUrl.Set(nil)
}
...
func (o *PutComputerPrestageV3) GetAccountSettings() AccountSettingsRequest {
	if o == nil || IsNil(o.AccountSettings) {
		var ret AccountSettingsRequest
		return ret
	}
...
// SetAccountSettings gets a reference to the given AccountSettingsRequest and assigns it to the AccountSettings field.
...
func (o PutComputerPrestageV3) MarshalJSON() ([]byte, error) {
...
func (o PutComputerPrestageV3) ToMap() (map[string]interface{}, error) {
...
func (o *PutComputerPrestageV3) UnmarshalJSON(data []byte) (err error) {
	...
	varPutComputerPrestageV3 := _PutComputerPrestageV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutComputerPrestageV3)

	if err != nil {
		return err
	}

	*o = PutComputerPrestageV3(varPutComputerPrestageV3)

	return err
}

type NullablePutComputerPrestageV3 struct {
	value *PutComputerPrestageV3
	isSet bool
}

func (v NullablePutComputerPrestageV3) Get() *PutComputerPrestageV3 {
	return v.value
}

func (v *NullablePutComputerPrestageV3) Set(val *PutComputerPrestageV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePutComputerPrestageV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePutComputerPrestageV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutComputerPrestageV3(val *PutComputerPrestageV3) *NullablePutComputerPrestageV3 {
	return &NullablePutComputerPrestageV3{value: val, isSet: true}
}

func (v NullablePutComputerPrestageV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutComputerPrestageV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
