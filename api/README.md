...
*SmtpServerAPI* | [**V1SmtpServerGet**](docs/SmtpServerAPI.md#v1smtpserverget) | **Get** /v1/smtp-server | Finds the Jamf Pro SMTP Server information 
...
*SmtpServerAPI* | [**V1SmtpServerPut**](docs/SmtpServerAPI.md#v1smtpserverput) | **Put** /v1/smtp-server | Updates Jamf Pro SMTP Server information 
...
*SsoSettingsAPI* | [**V2SsoDependenciesGet**](docs/SsoSettingsAPI.md#v2ssodependenciesget) | **Get** /v2/sso/dependencies | Retrieve the list of Enrollment Customizations using SSO 
*SsoSettingsAPI* | [**V2SsoDisablePost**](docs/SsoSettingsAPI.md#v2ssodisablepost) | **Post** /v2/sso/disable | Disable SSO 
*SsoSettingsAPI* | [**V2SsoGet**](docs/SsoSettingsAPI.md#v2ssoget) | **Get** /v2/sso | Retrieve the current Single Sign On configuration settings 
*SsoSettingsAPI* | [**V2SsoHistoryGet**](docs/SsoSettingsAPI.md#v2ssohistoryget) | **Get** /v2/sso/history | Get SSO history object 
*SsoSettingsAPI* | [**V2SsoHistoryPost**](docs/SsoSettingsAPI.md#v2ssohistorypost) | **Post** /v2/sso/history | Add SSO history object notes 
*SsoSettingsAPI* | [**V2SsoMetadataDownloadGet**](docs/SsoSettingsAPI.md#v2ssometadatadownloadget) | **Get** /v2/sso/metadata/download | Download the Jamf Pro SAML metadata file 
*SsoSettingsAPI* | [**V2SsoPut**](docs/SsoSettingsAPI.md#v2ssoput) | **Put** /v2/sso | Updates the current Single Sign On configuration settings 
*SsoSettingsAPI* | [**V2SsoValidatePost**](docs/SsoSettingsAPI.md#v2ssovalidatepost) | **Post** /v2/sso/validate | Endpoint for validation of a saml metadata url 
...
## Documentation For Models
 ...
 - [ComputerPluginCreate](docs/ComputerPluginCreate.md)
