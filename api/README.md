...
------------ | ------------- | ------------- | -------------
*AccountGroupsAPI* | [**V1AccountGroupsGet**](docs/AccountGroupsAPI.md#v1accountgroupsget) | **Get** /v1/account-groups | Get account groups
*AccountGroupsAPI* | [**V1AccountGroupsIdGet**](docs/AccountGroupsAPI.md#v1accountgroupsidget) | **Get** /v1/account-groups/{id} | Gets the account group. 
*AccountsAPI* | [**V1AccountsGet**](docs/AccountsAPI.md#v1accountsget) | **Get** /v1/accounts | Get user accounts
*AccountsAPI* | [**V1AccountsIdDelete**](docs/AccountsAPI.md#v1accountsiddelete) | **Delete** /v1/accounts/{id} | Deletes the user account. 
*AccountsAPI* | [**V1AccountsIdGet**](docs/AccountsAPI.md#v1accountsidget) | **Get** /v1/accounts/{id} | Gets the user account. 
*AccountsAPI* | [**V1AccountsIdPut**](docs/AccountsAPI.md#v1accountsidput) | **Put** /v1/accounts/{id} | Updates the user account. 
*AccountsAPI* | [**V1AccountsPost**](docs/AccountsAPI.md#v1accountspost) | **Post** /v1/accounts | Adds new account. 
*ActivationCodeAPI* | [**V1ActivationCodeHistoryExportPost**](docs/ActivationCodeAPI.md#v1activationcodehistoryexportpost) | **Post** /v1/activation-code/history/export | Export history object collection in specified format for Activation Code 
*ActivationCodeAPI* | [**V1ActivationCodeHistoryGet**](docs/ActivationCodeAPI.md#v1activationcodehistoryget) | **Get** /v1/activation-code/history | Get Activation Code history object
*ActivationCodeAPI* | [**V1ActivationCodeHistoryPost**](docs/ActivationCodeAPI.md#v1activationcodehistorypost) | **Post** /v1/activation-code/history | Add Activation Code object note 
*ActivationCodeAPI* | [**V1ActivationCodeOrganizationNamePatch**](docs/ActivationCodeAPI.md#v1activationcodeorganizationnamepatch) | **Patch** /v1/activation-code/organization-name | Updates Organization Name
...
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdDelete**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsiddelete) | **Delete** /v1/pki/adcs-settings/{id} | Delete AD CS Settings configuration by ID 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdDependenciesGet**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsiddependenciesget) | **Get** /v1/pki/adcs-settings/{id}/dependencies | Retrieve list of AD CS Settings dependencies
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdGet**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsidget) | **Get** /v1/pki/adcs-settings/{id} | Get AD CS Settings configuration for the ID value 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdHistoryGet**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsidhistoryget) | **Get** /v1/pki/adcs-settings/{id}/history | Get specified AD CS Settings history object 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdHistoryPost**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsidhistorypost) | **Post** /v1/pki/adcs-settings/{id}/history | Add specified AD CS Settings object note 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsIdPatch**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsidpatch) | **Patch** /v1/pki/adcs-settings/{id} | Update AD CS Settings configuration 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsPost**](docs/AdcsSettingsAPI.md#v1pkiadcssettingspost) | **Post** /v1/pki/adcs-settings | Create AD CS Settings configuration for either inbound or outbound mode 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsValidateCertificatePost**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsvalidatecertificatepost) | **Post** /v1/pki/adcs-settings/validate-certificate | Validate AD CS Settings server certificate 
*AdcsSettingsAPI* | [**V1PkiAdcsSettingsValidateClientCertificatePost**](docs/AdcsSettingsAPI.md#v1pkiadcssettingsvalidateclientcertificatepost) | **Post** /v1/pki/adcs-settings/validate-client-certificate | Validate AD CS Settings client certificate 
...
*ApiAuthenticationAPI* | [**PostOAuthToken**](docs/ApiAuthenticationAPI.md#postoauthtoken) | **Post** /v1/oauth/token | Obtain an access token using an API Client
...
*ApnsClientPushStatusAPI* | [**V1ApnsClientPushStatusEnableAllClientsPost**](docs/ApnsClientPushStatusAPI.md#v1apnsclientpushstatusenableallclientspost) | **Post** /v1/apns-client-push-status/enable-all-clients | Enable push notifications for all clients 
*ApnsClientPushStatusAPI* | [**V1ApnsClientPushStatusEnableAllClientsStatusGet**](docs/ApnsClientPushStatusAPI.md#v1apnsclientpushstatusenableallclientsstatusget) | **Get** /v1/apns-client-push-status/enable-all-clients/status | Get status of enable all clients request 
*ApnsClientPushStatusAPI* | [**V1ApnsClientPushStatusEnableClientPost**](docs/ApnsClientPushStatusAPI.md#v1apnsclientpushstatusenableclientpost) | **Post** /v1/apns-client-push-status/enable-client | Enable push notifications for a single client 
*ApnsClientPushStatusAPI* | [**V1ApnsClientPushStatusGet**](docs/ApnsClientPushStatusAPI.md#v1apnsclientpushstatusget) | **Get** /v1/apns-client-push-status | Search for clients with push notifications disabled 
...
*CloudDistributionPointAPI* | [**V1CloudDistributionPointDelete**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointdelete) | **Delete** /v1/cloud-distribution-point | Delete cloud distribution point.
*CloudDistributionPointAPI* | [**V1CloudDistributionPointFailUploadIdPost**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointfailuploadidpost) | **Post** /v1/cloud-distribution-point/fail-upload/{id} | Marks a specific file upload as failed for the currently configured cloud distribution point. 
*CloudDistributionPointAPI* | [**V1CloudDistributionPointFilesGet**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointfilesget) | **Get** /v1/cloud-distribution-point/files | Get the cloud distribution point Inventory files details
*CloudDistributionPointAPI* | [**V1CloudDistributionPointGet**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointget) | **Get** /v1/cloud-distribution-point | Get the cloud distribution point Details. 
*CloudDistributionPointAPI* | [**V1CloudDistributionPointHistoryGet**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointhistoryget) | **Get** /v1/cloud-distribution-point/history | Get cloud distribution point history details
*CloudDistributionPointAPI* | [**V1CloudDistributionPointHistoryPost**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointhistorypost) | **Post** /v1/cloud-distribution-point/history | Add specified cloud distribution point history object notes
*CloudDistributionPointAPI* | [**V1CloudDistributionPointPatch**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointpatch) | **Patch** /v1/cloud-distribution-point | Update specific fields on a cloud distribution point
*CloudDistributionPointAPI* | [**V1CloudDistributionPointPost**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointpost) | **Post** /v1/cloud-distribution-point | Create cloud distribution point
*CloudDistributionPointAPI* | [**V1CloudDistributionPointRefreshInventoryPost**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointrefreshinventorypost) | **Post** /v1/cloud-distribution-point/refresh-inventory | Updates inventory data for the currently configured cloud distribution point. 
*CloudDistributionPointAPI* | [**V1CloudDistributionPointTestConnectionGet**](docs/CloudDistributionPointAPI.md#v1clouddistributionpointtestconnectionget) | **Get** /v1/cloud-distribution-point/test-connection | Get the cloud distribution point test connection details. 
...
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesDeleteMultiplePost**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesdeletemultiplepost) | **Post** /v1/computer-extension-attributes/delete-multiple | Delete multiple Computer Extension Attribute at once.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesget) | **Get** /v1/computer-extension-attributes | Retrieve Computer Extension Attributes.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdDataDependencyGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesiddatadependencyget) | **Get** /v1/computer-extension-attributes/{id}/data-dependency | Get smart group/advance search dependent objects for a specified computer extension attribute
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdDelete**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesiddelete) | **Delete** /v1/computer-extension-attributes/{id} | Remove specified Computer Extension Attribute.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdDownloadGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesiddownloadget) | **Get** /v1/computer-extension-attributes/{id}/download | Download the specified Computer Extension Attribute.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesidget) | **Get** /v1/computer-extension-attributes/{id} | Get specified Computer Extension Attribute object.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdHistoryGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesidhistoryget) | **Get** /v1/computer-extension-attributes/{id}/history | Get specified Computer Extension Attribute History object
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdHistoryPost**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesidhistorypost) | **Post** /v1/computer-extension-attributes/{id}/history | Add specified Computer Extension Attribute history object notes
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesIdPut**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesidput) | **Put** /v1/computer-extension-attributes/{id} | Update specified Computer Extension Attribute object.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesPost**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributespost) | **Post** /v1/computer-extension-attributes | Create Computer Extension Attribute.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesTemplatesGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributestemplatesget) | **Get** /v1/computer-extension-attributes/templates | Retrieve All Computer Extension Attributes Templates.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesTemplatesIdGet**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributestemplatesidget) | **Get** /v1/computer-extension-attributes/templates/{id} | Get specified Computer Extension Attribute Template object.
*ComputerExtensionAttributesAPI* | [**V1ComputerExtensionAttributesUploadPost**](docs/ComputerExtensionAttributesAPI.md#v1computerextensionattributesuploadpost) | **Post** /v1/computer-extension-attributes/upload | Upload Computer Extension Attribute.
...
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupMembershipIdGet**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupmembershipidget) | **Get** /v2/computer-groups/smart-group-membership/{id} | Get the membership of a Smart Computer Group 
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupsGet**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupsget) | **Get** /v2/computer-groups/smart-groups | Search for Smart Computer Groups 
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupsIdDelete**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupsiddelete) | **Delete** /v2/computer-groups/smart-groups/{id} | Remove specified Smart Computer Group 
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupsIdGet**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupsidget) | **Get** /v2/computer-groups/smart-groups/{id} | Get Smart Computer Group by Id 
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupsIdPut**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupsidput) | **Put** /v2/computer-groups/smart-groups/{id} | Update a Smart Computer Group 
*ComputerGroupsAPI* | [**V2ComputerGroupsSmartGroupsPost**](docs/ComputerGroupsAPI.md#v2computergroupssmartgroupspost) | **Post** /v2/computer-groups/smart-groups | Create a Smart Computer Group 
*ComputerGroupsAPI* | [**V2ComputerGroupsStaticGroupsGet**](docs/ComputerGroupsAPI.md#v2computergroupsstaticgroupsget) | **Get** /v2/computer-groups/static-groups | Search for Static Computer Groups 
*ComputerGroupsAPI* | [**V2ComputerGroupsStaticGroupsIdDelete**](docs/ComputerGroupsAPI.md#v2computergroupsstaticgroupsiddelete) | **Delete** /v2/computer-groups/static-groups/{id} | Remove Static Computer Group by Id 
*ComputerGroupsAPI* | [**V2ComputerGroupsStaticGroupsIdGet**](docs/ComputerGroupsAPI.md#v2computergroupsstaticgroupsidget) | **Get** /v2/computer-groups/static-groups/{id} | Get Static Computer Group by Id 
*ComputerGroupsAPI* | [**V2ComputerGroupsStaticGroupsIdPut**](docs/ComputerGroupsAPI.md#v2computergroupsstaticgroupsidput) | **Put** /v2/computer-groups/static-groups/{id} | Update membership of a static computer group. 
*ComputerGroupsAPI* | [**V2ComputerGroupsStaticGroupsPost**](docs/ComputerGroupsAPI.md#v2computergroupsstaticgroupspost) | **Post** /v2/computer-groups/static-groups | Create membership of a static computer group. 
*ComputerInventoryAPI* | [**V1ComputerInventoryIdErasePost**](docs/ComputerInventoryAPI.md#v1computerinventoryiderasepost) | **Post** /v1/computer-inventory/{id}/erase | Erase a computer 
*ComputerInventoryAPI* | [**V1ComputerInventoryIdRemoveMdmProfilePost**](docs/ComputerInventoryAPI.md#v1computerinventoryidremovemdmprofilepost) | **Post** /v1/computer-inventory/{id}/remove-mdm-profile | Remove a computer&#39;s MDM profile 
...
*ComputerInventoryAPI* | [**V1ComputersInventoryIdViewDeviceLockPinGet**](docs/ComputerInventoryAPI.md#v1computersinventoryidviewdevicelockpinget) | **Get** /v1/computers-inventory/{id}/view-device-lock-pin | Return a computer&#39;s Device Lock PIN
...
*ComputerInventoryAPI* | [**V1ComputersInventoryPost**](docs/ComputerInventoryAPI.md#v1computersinventorypost) | **Post** /v1/computers-inventory | Create Computer Inventory record
*ComputerInventoryAPI* | [**V2ComputersInventoryDetailIdGet**](docs/ComputerInventoryAPI.md#v2computersinventorydetailidget) | **Get** /v2/computers-inventory-detail/{id} | Return all sections of a computer
*ComputerInventoryAPI* | [**V2ComputersInventoryDetailIdPatch**](docs/ComputerInventoryAPI.md#v2computersinventorydetailidpatch) | **Patch** /v2/computers-inventory-detail/{id} | Update specific fields on a computer
*ComputerInventoryAPI* | [**V2ComputersInventoryFilevaultGet**](docs/ComputerInventoryAPI.md#v2computersinventoryfilevaultget) | **Get** /v2/computers-inventory/filevault | Return paginated FileVault information for all computers
*ComputerInventoryAPI* | [**V2ComputersInventoryGet**](docs/ComputerInventoryAPI.md#v2computersinventoryget) | **Get** /v2/computers-inventory | Return paginated Computer Inventory records
*ComputerInventoryAPI* | [**V2ComputersInventoryIdAttachmentsAttachmentIdDelete**](docs/ComputerInventoryAPI.md#v2computersinventoryidattachmentsattachmentiddelete) | **Delete** /v2/computers-inventory/{id}/attachments/{attachmentId} | Remove attachment
*ComputerInventoryAPI* | [**V2ComputersInventoryIdAttachmentsAttachmentIdGet**](docs/ComputerInventoryAPI.md#v2computersinventoryidattachmentsattachmentidget) | **Get** /v2/computers-inventory/{id}/attachments/{attachmentId} | Download attachment file
*ComputerInventoryAPI* | [**V2ComputersInventoryIdAttachmentsPost**](docs/ComputerInventoryAPI.md#v2computersinventoryidattachmentspost) | **Post** /v2/computers-inventory/{id}/attachments | Upload attachment and assign to computer
*ComputerInventoryAPI* | [**V2ComputersInventoryIdDelete**](docs/ComputerInventoryAPI.md#v2computersinventoryiddelete) | **Delete** /v2/computers-inventory/{id} | Remove specified Computer record
*ComputerInventoryAPI* | [**V2ComputersInventoryIdFilevaultGet**](docs/ComputerInventoryAPI.md#v2computersinventoryidfilevaultget) | **Get** /v2/computers-inventory/{id}/filevault | Return FileVault information for a specific computer
*ComputerInventoryAPI* | [**V2ComputersInventoryIdGet**](docs/ComputerInventoryAPI.md#v2computersinventoryidget) | **Get** /v2/computers-inventory/{id} | Return General section of a Computer
*ComputerInventoryAPI* | [**V2ComputersInventoryIdViewDeviceLockPinGet**](docs/ComputerInventoryAPI.md#v2computersinventoryidviewdevicelockpinget) | **Get** /v2/computers-inventory/{id}/view-device-lock-pin | Return a computer&#39;s Device Lock PIN
*ComputerInventoryAPI* | [**V2ComputersInventoryIdViewRecoveryLockPasswordGet**](docs/ComputerInventoryAPI.md#v2computersinventoryidviewrecoverylockpasswordget) | **Get** /v2/computers-inventory/{id}/view-recovery-lock-password | Return a Computers Recovery Lock Password
*ComputerInventoryAPI* | [**V2ComputersInventoryPost**](docs/ComputerInventoryAPI.md#v2computersinventorypost) | **Post** /v2/computers-inventory | Create Computer Inventory record
*ComputerInventoryAPI* | [**V3ComputersInventoryDetailIdGet**](docs/ComputerInventoryAPI.md#v3computersinventorydetailidget) | **Get** /v3/computers-inventory-detail/{id} | Return all sections of a computer
*ComputerInventoryAPI* | [**V3ComputersInventoryDetailIdPatch**](docs/ComputerInventoryAPI.md#v3computersinventorydetailidpatch) | **Patch** /v3/computers-inventory-detail/{id} | Update specific fields on a computer
*ComputerInventoryAPI* | [**V3ComputersInventoryFilevaultGet**](docs/ComputerInventoryAPI.md#v3computersinventoryfilevaultget) | **Get** /v3/computers-inventory/filevault | Return paginated FileVault information for all computers
*ComputerInventoryAPI* | [**V3ComputersInventoryGet**](docs/ComputerInventoryAPI.md#v3computersinventoryget) | **Get** /v3/computers-inventory | Return paginated Computer Inventory records
*ComputerInventoryAPI* | [**V3ComputersInventoryIdAttachmentsAttachmentIdDelete**](docs/ComputerInventoryAPI.md#v3computersinventoryidattachmentsattachmentiddelete) | **Delete** /v3/computers-inventory/{id}/attachments/{attachmentId} | Remove attachment
*ComputerInventoryAPI* | [**V3ComputersInventoryIdAttachmentsAttachmentIdGet**](docs/ComputerInventoryAPI.md#v3computersinventoryidattachmentsattachmentidget) | **Get** /v3/computers-inventory/{id}/attachments/{attachmentId} | Download attachment file
*ComputerInventoryAPI* | [**V3ComputersInventoryIdAttachmentsPost**](docs/ComputerInventoryAPI.md#v3computersinventoryidattachmentspost) | **Post** /v3/computers-inventory/{id}/attachments | Upload attachment and assign to computer
*ComputerInventoryAPI* | [**V3ComputersInventoryIdDelete**](docs/ComputerInventoryAPI.md#v3computersinventoryiddelete) | **Delete** /v3/computers-inventory/{id} | Remove specified Computer record
*ComputerInventoryAPI* | [**V3ComputersInventoryIdFilevaultGet**](docs/ComputerInventoryAPI.md#v3computersinventoryidfilevaultget) | **Get** /v3/computers-inventory/{id}/filevault | Return FileVault information for a specific computer
*ComputerInventoryAPI* | [**V3ComputersInventoryIdGet**](docs/ComputerInventoryAPI.md#v3computersinventoryidget) | **Get** /v3/computers-inventory/{id} | Return General section of a Computer
*ComputerInventoryAPI* | [**V3ComputersInventoryIdViewDeviceLockPinGet**](docs/ComputerInventoryAPI.md#v3computersinventoryidviewdevicelockpinget) | **Get** /v3/computers-inventory/{id}/view-device-lock-pin | Return a computer&#39;s Device Lock PIN
*ComputerInventoryAPI* | [**V3ComputersInventoryIdViewRecoveryLockPasswordGet**](docs/ComputerInventoryAPI.md#v3computersinventoryidviewrecoverylockpasswordget) | **Get** /v3/computers-inventory/{id}/view-recovery-lock-password | Return a Computers Recovery Lock Password
*ComputerInventoryAPI* | [**V3ComputersInventoryPost**](docs/ComputerInventoryAPI.md#v3computersinventorypost) | **Post** /v3/computers-inventory | Create Computer Inventory record
...
*ComputerInventoryCollectionSettingsAPI* | [**V2ComputerInventoryCollectionSettingsCustomPathIdDelete**](docs/ComputerInventoryCollectionSettingsAPI.md#v2computerinventorycollectionsettingscustompathiddelete) | **Delete** /v2/computer-inventory-collection-settings/custom-path/{id} | Delete Custom Path from Computer Inventory Collection Settings
*ComputerInventoryCollectionSettingsAPI* | [**V2ComputerInventoryCollectionSettingsCustomPathPost**](docs/ComputerInventoryCollectionSettingsAPI.md#v2computerinventorycollectionsettingscustompathpost) | **Post** /v2/computer-inventory-collection-settings/custom-path | Create Computer Inventory Collection Settings Custom Path
*ComputerInventoryCollectionSettingsAPI* | [**V2ComputerInventoryCollectionSettingsGet**](docs/ComputerInventoryCollectionSettingsAPI.md#v2computerinventorycollectionsettingsget) | **Get** /v2/computer-inventory-collection-settings | Returns computer inventory settings
*ComputerInventoryCollectionSettingsAPI* | [**V2ComputerInventoryCollectionSettingsPatch**](docs/ComputerInventoryCollectionSettingsAPI.md#v2computerinventorycollectionsettingspatch) | **Patch** /v2/computer-inventory-collection-settings | Update computer inventory settings
...
*DashboardAPI* | [**V1DashboardTogglePost**](docs/DashboardAPI.md#v1dashboardtogglepost) | **Post** /v1/dashboard/toggle | Add or remove an object to the Jamf Pro dashboard 
*DeclarativeDeviceManagementAPI* | [**V1DdmClientManagementIdStatusItemsGet**](docs/DeclarativeDeviceManagementAPI.md#v1ddmclientmanagementidstatusitemsget) | **Get** /v1/ddm/{clientManagementId}/status-items | Retrieve the Status Items from the latest Status Report for a device
*DeclarativeDeviceManagementAPI* | [**V1DdmClientManagementIdStatusItemsKeyGet**](docs/DeclarativeDeviceManagementAPI.md#v1ddmclientmanagementidstatusitemskeyget) | **Get** /v1/ddm/{clientManagementId}/status-items/{key} | Retrieve a Status Item from the latest Status Report for a device
*DeclarativeDeviceManagementAPI* | [**V1DdmClientManagementIdSyncPost**](docs/DeclarativeDeviceManagementAPI.md#v1ddmclientmanagementidsyncpost) | **Post** /v1/ddm/{clientManagementId}/sync | Force a device DDM sync
*DeclarativeDeviceManagementAPI* | [**V1DssDeclarationsDeclarationIdGet**](docs/DeclarativeDeviceManagementAPI.md#v1dssdeclarationsdeclarationidget) | **Get** /v1/dss-declarations/{declarationId} | Retrieve an existing declaration
...
*DevicesAPI* | [**V1DevicesIdGroupsGet**](docs/DevicesAPI.md#v1devicesidgroupsget) | **Get** /v1/devices/{id}/groups | Return a list of groups for a device 
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerIdConnectionStatusGet**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanageridconnectionstatusget) | **Get** /v1/pki/digicert/trust-lifecycle-manager/{id}/connection-status | Get connection status of DigiCert Trust Lifecycle Manager for a given ID
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerIdDelete**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanageriddelete) | **Delete** /v1/pki/digicert/trust-lifecycle-manager/{id} | Delete DigiCert Trust Lifecycle Manager configuration
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerIdDependenciesGet**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanageriddependenciesget) | **Get** /v1/pki/digicert/trust-lifecycle-manager/{id}/dependencies | Retrieve list of DigiCert Trust Lifecycle Manager Settings dependencies
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerIdGet**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanageridget) | **Get** /v1/pki/digicert/trust-lifecycle-manager/{id} | Retrieve DigiCert Trust Lifecycle Manager configuration
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerIdPatch**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanageridpatch) | **Patch** /v1/pki/digicert/trust-lifecycle-manager/{id} | Update DigiCert Trust Lifecycle Manager configuration 
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerPost**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanagerpost) | **Post** /v1/pki/digicert/trust-lifecycle-manager | Create DigiCert Trust Lifecycle Manager configuration with client authentication via client certificate. 
*DigicertAPI* | [**V1PkiDigicertTrustLifecycleManagerValidateClientCertificatePost**](docs/DigicertAPI.md#v1pkidigicerttrustlifecyclemanagervalidateclientcertificatepost) | **Post** /v1/pki/digicert/trust-lifecycle-manager/validate-client-certificate | Validate DigiCert Trust Lifecycle Manager client certificate 
*DistributionPointAPI* | [**V1DistributionPointsDeleteMultiplePost**](docs/DistributionPointAPI.md#v1distributionpointsdeletemultiplepost) | **Post** /v1/distribution-points/delete-multiple | Delete multiple distribution points at once
*DistributionPointAPI* | [**V1DistributionPointsGet**](docs/DistributionPointAPI.md#v1distributionpointsget) | **Get** /v1/distribution-points | Finds all Distribution Points
*DistributionPointAPI* | [**V1DistributionPointsIdDelete**](docs/DistributionPointAPI.md#v1distributionpointsiddelete) | **Delete** /v1/distribution-points/{id} | Remove specified distribution point 
*DistributionPointAPI* | [**V1DistributionPointsIdGet**](docs/DistributionPointAPI.md#v1distributionpointsidget) | **Get** /v1/distribution-points/{id} | Get specified distribution point 
*DistributionPointAPI* | [**V1DistributionPointsIdHistoryGet**](docs/DistributionPointAPI.md#v1distributionpointsidhistoryget) | **Get** /v1/distribution-points/{id}/history | Get specified distribution point History object 
*DistributionPointAPI* | [**V1DistributionPointsIdHistoryPost**](docs/DistributionPointAPI.md#v1distributionpointsidhistorypost) | **Post** /v1/distribution-points/{id}/history | Add specified distribution point History object notes 
*DistributionPointAPI* | [**V1DistributionPointsIdPatch**](docs/DistributionPointAPI.md#v1distributionpointsidpatch) | **Patch** /v1/distribution-points/{id} | Update specified distribution point object 
*DistributionPointAPI* | [**V1DistributionPointsIdPut**](docs/DistributionPointAPI.md#v1distributionpointsidput) | **Put** /v1/distribution-points/{id} | Update specified distribution point object 
*DistributionPointAPI* | [**V1DistributionPointsPost**](docs/DistributionPointAPI.md#v1distributionpointspost) | **Post** /v1/distribution-points | Create distribution point
...
*EnrollmentAPI* | [**V4EnrollmentAccessManagementGet**](docs/EnrollmentAPI.md#v4enrollmentaccessmanagementget) | **Get** /v4/enrollment/access-management | Get Access Management settings
*EnrollmentAPI* | [**V4EnrollmentAccessManagementPost**](docs/EnrollmentAPI.md#v4enrollmentaccessmanagementpost) | **Post** /v4/enrollment/access-management | Configure Access Management settings 
...
*GroupsAPI* | [**V1GroupsGet**](docs/GroupsAPI.md#v1groupsget) | **Get** /v1/groups | Returns group information for all Mobile Device and Computer groups
*GroupsAPI* | [**V1GroupsIdDelete**](docs/GroupsAPI.md#v1groupsiddelete) | **Delete** /v1/groups/{id} | Delete a group by platform UUID
*GroupsAPI* | [**V1GroupsIdGet**](docs/GroupsAPI.md#v1groupsidget) | **Get** /v1/groups/{id} | Returns group information for the given platform UUID
*GroupsAPI* | [**V1GroupsIdPatch**](docs/GroupsAPI.md#v1groupsidpatch) | **Patch** /v1/groups/{id} | Update a group by platform UUID
...
*HealthCheckAPI* | [**V1HealthStatusGet**](docs/HealthCheckAPI.md#v1healthstatusget) | **Get** /v1/health-status | Retrieve request acceptance ratios for this Jamf Pro node
...
*ImpactAlertNotificationSettingsAPI* | [**V1ImpactAlertNotificationSettingsGet**](docs/ImpactAlertNotificationSettingsAPI.md#v1impactalertnotificationsettingsget) | **Get** /v1/impact-alert-notification-settings | Get Impact Alert Notification Settings
*ImpactAlertNotificationSettingsAPI* | [**V1ImpactAlertNotificationSettingsPut**](docs/ImpactAlertNotificationSettingsAPI.md#v1impactalertnotificationsettingsput) | **Put** /v1/impact-alert-notification-settings | Update Impact Alert Notification Settings
...
*JamfCloudDistributionServiceAPI* | [**V1JcdsFilesFileNameDelete**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsfilesfilenamedelete) | **Delete** /v1/jcds/files/{fileName} | Delete a file from the Jamf Cloud Distribution Service
*JamfCloudDistributionServiceAPI* | [**V1JcdsFilesFileNameGet**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsfilesfilenameget) | **Get** /v1/jcds/files/{fileName} | Retrieve a download URL for a specific file from the Jamf Cloud Distribution Service
*JamfCloudDistributionServiceAPI* | [**V1JcdsFilesGet**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsfilesget) | **Get** /v1/jcds/files | Retrieve a list of files and file metadata from the Jamf Cloud Distribution Service
*JamfCloudDistributionServiceAPI* | [**V1JcdsFilesPost**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsfilespost) | **Post** /v1/jcds/files | Initiate an upload to the Jamf Cloud Distribution Service
*JamfCloudDistributionServiceAPI* | [**V1JcdsRefreshInventoryPost**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsrefreshinventorypost) | **Post** /v1/jcds/refresh-inventory | Refreshes the inventory and status of uploads in Jamf Pro. This will update the  status of uploads in the Jamf Pro database and allow the uploads to be deployed. 
*JamfCloudDistributionServiceAPI* | [**V1JcdsRenewCredentialsPost**](docs/JamfCloudDistributionServiceAPI.md#v1jcdsrenewcredentialspost) | **Post** /v1/jcds/renew-credentials | Renew credentials for an upload to the Jamf Cloud Distribution Service
...
*JamfProAccountPreferencesAPI* | [**V3AccountPreferencesGet**](docs/JamfProAccountPreferencesAPI.md#v3accountpreferencesget) | **Get** /v3/account-preferences | Get Jamf Pro account preferences 
*JamfProAccountPreferencesAPI* | [**V3AccountPreferencesPatch**](docs/JamfProAccountPreferencesAPI.md#v3accountpreferencespatch) | **Patch** /v3/account-preferences | Update Jamf Pro account preferences 
...
*JamfProInitializationAPI* | [**V1SystemPlatformInitializePost**](docs/JamfProInitializationAPI.md#v1systemplatforminitializepost) | **Post** /v1/system/platform-initialize | Set up fresh installed Jamf Pro Server for Platform 
...
*LastLoginAPI* | [**V1LastLoginGet**](docs/LastLoginAPI.md#v1lastloginget) | **Get** /v1/last-login | Get the date of the last login event
...
*LogFlushingAPI* | [**V1LogFlushingGet**](docs/LogFlushingAPI.md#v1logflushingget) | **Get** /v1/log-flushing | Get log flushing settings
*LogFlushingAPI* | [**V1LogFlushingTaskGet**](docs/LogFlushingAPI.md#v1logflushingtaskget) | **Get** /v1/log-flushing/task | Get log flushing tasks
*LogFlushingAPI* | [**V1LogFlushingTaskIdDelete**](docs/LogFlushingAPI.md#v1logflushingtaskiddelete) | **Delete** /v1/log-flushing/task/{id} | Cancels a log flushing task
*LogFlushingAPI* | [**V1LogFlushingTaskIdGet**](docs/LogFlushingAPI.md#v1logflushingtaskidget) | **Get** /v1/log-flushing/task/{id} | Get log flushing task
*LogFlushingAPI* | [**V1LogFlushingTaskPost**](docs/LogFlushingAPI.md#v1logflushingtaskpost) | **Post** /v1/log-flushing/task | Queue a log flushing task
...
*MdmAPI* | [**V2MdmBlankPushPost**](docs/MdmAPI.md#v2mdmblankpushpost) | **Post** /v2/mdm/blank-push | Send blank push notifications to a list of client management IDs.
...
*MdmRenewalAPI* | [**V1MdmRenewalDeviceCommonDetailsClientManagementIdGet**](docs/MdmRenewalAPI.md#v1mdmrenewaldevicecommondetailsclientmanagementidget) | **Get** /v1/mdm-renewal/device-common-details/{clientManagementId} | Get device common details for a client management ID 
*MdmRenewalAPI* | [**V1MdmRenewalDeviceCommonDetailsPatch**](docs/MdmRenewalAPI.md#v1mdmrenewaldevicecommondetailspatch) | **Patch** /v1/mdm-renewal/device-common-details | Update device common details (partial update) 
*MdmRenewalAPI* | [**V1MdmRenewalRenewalStrategiesClientManagementIdDelete**](docs/MdmRenewalAPI.md#v1mdmrenewalrenewalstrategiesclientmanagementiddelete) | **Delete** /v1/mdm-renewal/renewal-strategies/{clientManagementId} | Delete MDM renewal strategies for a client management ID 
*MdmRenewalAPI* | [**V1MdmRenewalRenewalStrategiesClientManagementIdGet**](docs/MdmRenewalAPI.md#v1mdmrenewalrenewalstrategiesclientmanagementidget) | **Get** /v1/mdm-renewal/renewal-strategies/{clientManagementId} | Get MDM renewal errors and strategies for a client management ID 
...
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesGet**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesget) | **Get** /v1/mobile-device-extension-attributes | Retrieve Mobile Device Extension Attributes.
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdDataDependencyGet**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesiddatadependencyget) | **Get** /v1/mobile-device-extension-attributes/{id}/data-dependency | Get smart group dependent object for a specified mobile device extension attribute
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdDelete**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesiddelete) | **Delete** /v1/mobile-device-extension-attributes/{id} | Delete a Mobile Device Extension Attribute by ID.
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdGet**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesidget) | **Get** /v1/mobile-device-extension-attributes/{id} | Get specified Mobile Device Extension Attribute object.
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdHistoryGet**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesidhistoryget) | **Get** /v1/mobile-device-extension-attributes/{id}/history | Get specified Mobile Device Extension Attribute History object
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdHistoryPost**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesidhistorypost) | **Post** /v1/mobile-device-extension-attributes/{id}/history | Add specified Mobile Device Extension Attribute history object notes
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesIdPut**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributesidput) | **Put** /v1/mobile-device-extension-attributes/{id} | Update specified Mobile Device Extension Attribute object.
*MobileDeviceExtensionAttributesAPI* | [**V1MobileDeviceExtensionAttributesPost**](docs/MobileDeviceExtensionAttributesAPI.md#v1mobiledeviceextensionattributespost) | **Post** /v1/mobile-device-extension-attributes | Create Mobile Device Extension Attribute.
...
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsIdErasePost**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupsiderasepost) | **Post** /v1/mobile-device-groups/{id}/erase | Erase all devices in the group 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupMembershipIdGet**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupmembershipidget) | **Get** /v1/mobile-device-groups/smart-group-membership/{id} | Get Smart Group Membership by Id 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupsGet**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupsget) | **Get** /v1/mobile-device-groups/smart-groups | Get Smart Groups 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupsIdDelete**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupsiddelete) | **Delete** /v1/mobile-device-groups/smart-groups/{id} | Remove Smart Group by Id 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupsIdGet**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupsidget) | **Get** /v1/mobile-device-groups/smart-groups/{id} | Get Smart Group by Id 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupsIdPut**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupsidput) | **Put** /v1/mobile-device-groups/smart-groups/{id} | Update a smart group 
*MobileDeviceGroupsAPI* | [**V1MobileDeviceGroupsSmartGroupsPost**](docs/MobileDeviceGroupsAPI.md#v1mobiledevicegroupssmartgroupspost) | **Post** /v1/mobile-device-groups/smart-groups | Create a smart group 
...
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesGet**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesget) | **Get** /v3/mobile-device-prestages | Get sorted and paged Mobile Device Prestages 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdAttachmentsDeleteMultiplePost**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidattachmentsdeletemultiplepost) | **Post** /v3/mobile-device-prestages/{id}/attachments/delete-multiple | Remove an attachment for a Mobile Device Prestage 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdAttachmentsGet**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidattachmentsget) | **Get** /v3/mobile-device-prestages/{id}/attachments | Get attachments for a Mobile Device Prestage 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdAttachmentsPost**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidattachmentspost) | **Post** /v3/mobile-device-prestages/{id}/attachments | Add an attachment to a Mobile Device Prestage 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdDelete**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesiddelete) | **Delete** /v3/mobile-device-prestages/{id} | Delete a Mobile Device Prestage with the supplied id 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdGet**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidget) | **Get** /v3/mobile-device-prestages/{id} | Retrieve a Mobile Device Prestage with the supplied id 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdHistoryGet**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidhistoryget) | **Get** /v3/mobile-device-prestages/{id}/history | Get sorted and paged Mobile Device Prestage history objects 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdHistoryPost**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidhistorypost) | **Post** /v3/mobile-device-prestages/{id}/history | Add Mobile Device Prestage history object notes 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesIdPut**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagesidput) | **Put** /v3/mobile-device-prestages/{id} | Update a Mobile Device Prestage 
*MobileDevicePrestagesAPI* | [**V3MobileDevicePrestagesPost**](docs/MobileDevicePrestagesAPI.md#v3mobiledeviceprestagespost) | **Post** /v3/mobile-device-prestages | Create a Mobile Device Prestage 
...
*MobileDevicesAPI* | [**V2MobileDevicesIdErasePost**](docs/MobileDevicesAPI.md#v2mobiledevicesiderasepost) | **Post** /v2/mobile-devices/{id}/erase | Erase a Mobile Device 
...
*MobileDevicesAPI* | [**V2MobileDevicesIdPairedDevicesGet**](docs/MobileDevicesAPI.md#v2mobiledevicesidpaireddevicesget) | **Get** /v2/mobile-devices/{id}/paired-devices | Return paginated Mobile Device Inventory records of all paired devices for the device 
...
*MobileDevicesAPI* | [**V2MobileDevicesIdUnmanagePost**](docs/MobileDevicesAPI.md#v2mobiledevicesidunmanagepost) | **Post** /v2/mobile-devices/{id}/unmanage | Unmanage a Mobile Device 
*OidcAPI* | [**V1OidcDirectIdpLoginUrlGet**](docs/OidcAPI.md#v1oidcdirectidploginurlget) | **Get** /v1/oidc/direct-idp-login-url | Retrieve the URL to directly login to the IdP 
*OidcAPI* | [**V1OidcDispatchPost**](docs/OidcAPI.md#v1oidcdispatchpost) | **Post** /v1/oidc/dispatch | Provide the url to redirect for OIDC login
*OidcAPI* | [**V1OidcGenerateCertificatePost**](docs/OidcAPI.md#v1oidcgeneratecertificatepost) | **Post** /v1/oidc/generate-certificate | Generate a new keystore used for signing OIDC messages 
*OidcAPI* | [**V1OidcPublicFeaturesGet**](docs/OidcAPI.md#v1oidcpublicfeaturesget) | **Get** /v1/oidc/public-features | Get the public features of the OIDC configuration
*OidcAPI* | [**V1OidcPublicKeyGet**](docs/OidcAPI.md#v1oidcpublickeyget) | **Get** /v1/oidc/public-key | Get the public key of the keystore used for signing OIDC messages as a JWT 
*OidcAPI* | [**V2OidcDispatchPost**](docs/OidcAPI.md#v2oidcdispatchpost) | **Post** /v2/oidc/dispatch | Provide the url to redirect for OIDC login
*OnboardingAPI* | [**V1OnboardingEligibleAppsGet**](docs/OnboardingAPI.md#v1onboardingeligibleappsget) | **Get** /v1/onboarding/eligible-apps | Retrieves a list of applications that are eligible to be used in an onboarding configuration
*OnboardingAPI* | [**V1OnboardingEligibleConfigurationProfilesGet**](docs/OnboardingAPI.md#v1onboardingeligibleconfigurationprofilesget) | **Get** /v1/onboarding/eligible-configuration-profiles | Retrieves a list of configuration profiles that are eligible to be used in an onboarding configuration
*OnboardingAPI* | [**V1OnboardingEligiblePoliciesGet**](docs/OnboardingAPI.md#v1onboardingeligiblepoliciesget) | **Get** /v1/onboarding/eligible-policies | Retrieves a list of policies that are eligible to be used in an onboarding configuration
*OnboardingAPI* | [**V1OnboardingGet**](docs/OnboardingAPI.md#v1onboardingget) | **Get** /v1/onboarding | Get the current onboarding settings configuration.
*OnboardingAPI* | [**V1OnboardingHistoryExportPost**](docs/OnboardingAPI.md#v1onboardinghistoryexportpost) | **Post** /v1/onboarding/history/export | Export history object collection in specified format for Onboarding 
*OnboardingAPI* | [**V1OnboardingHistoryGet**](docs/OnboardingAPI.md#v1onboardinghistoryget) | **Get** /v1/onboarding/history | Get Onboarding history object 
*OnboardingAPI* | [**V1OnboardingHistoryPost**](docs/OnboardingAPI.md#v1onboardinghistorypost) | **Post** /v1/onboarding/history | Add Onboarding history object notes 
*OnboardingAPI* | [**V1OnboardingPut**](docs/OnboardingAPI.md#v1onboardingput) | **Put** /v1/onboarding | Update the onboarding configuration.
*PackagesAPI* | [**V1PackagesDeleteMultiplePost**](docs/PackagesAPI.md#v1packagesdeletemultiplepost) | **Post** /v1/packages/delete-multiple | Delete multiple packages at once
*PackagesAPI* | [**V1PackagesExportPost**](docs/PackagesAPI.md#v1packagesexportpost) | **Post** /v1/packages/export | Export Packages collection 
*PackagesAPI* | [**V1PackagesGet**](docs/PackagesAPI.md#v1packagesget) | **Get** /v1/packages | Retrieve Packages
*PackagesAPI* | [**V1PackagesIdDelete**](docs/PackagesAPI.md#v1packagesiddelete) | **Delete** /v1/packages/{id} | Remove specified package 
*PackagesAPI* | [**V1PackagesIdGet**](docs/PackagesAPI.md#v1packagesidget) | **Get** /v1/packages/{id} | Get specified Package object 
*PackagesAPI* | [**V1PackagesIdHistoryExportPost**](docs/PackagesAPI.md#v1packagesidhistoryexportpost) | **Post** /v1/packages/{id}/history/export | Export history object collection in specified format for specified Packages 
*PackagesAPI* | [**V1PackagesIdHistoryGet**](docs/PackagesAPI.md#v1packagesidhistoryget) | **Get** /v1/packages/{id}/history | Get specified Package History object 
*PackagesAPI* | [**V1PackagesIdHistoryPost**](docs/PackagesAPI.md#v1packagesidhistorypost) | **Post** /v1/packages/{id}/history | Add specified Package history object notes 
*PackagesAPI* | [**V1PackagesIdManifestDelete**](docs/PackagesAPI.md#v1packagesidmanifestdelete) | **Delete** /v1/packages/{id}/manifest | Delete the manifest for a specified package 
*PackagesAPI* | [**V1PackagesIdManifestPost**](docs/PackagesAPI.md#v1packagesidmanifestpost) | **Post** /v1/packages/{id}/manifest | Add a manifest to a package 
*PackagesAPI* | [**V1PackagesIdPut**](docs/PackagesAPI.md#v1packagesidput) | **Put** /v1/packages/{id} | Update specified package object 
*PackagesAPI* | [**V1PackagesIdUploadPost**](docs/PackagesAPI.md#v1packagesiduploadpost) | **Post** /v1/packages/{id}/upload | Upload package
*PackagesAPI* | [**V1PackagesPost**](docs/PackagesAPI.md#v1packagespost) | **Post** /v1/packages | Create package
...
*ReturnToServiceAPI* | [**V1ReturnToServiceGet**](docs/ReturnToServiceAPI.md#v1returntoserviceget) | **Get** /v1/return-to-service | Get all Return to Service Configurations 
*ReturnToServiceAPI* | [**V1ReturnToServiceIdDelete**](docs/ReturnToServiceAPI.md#v1returntoserviceiddelete) | **Delete** /v1/return-to-service/{id} | Delete a Return To Service Configuration with the supplied id 
*ReturnToServiceAPI* | [**V1ReturnToServiceIdGet**](docs/ReturnToServiceAPI.md#v1returntoserviceidget) | **Get** /v1/return-to-service/{id} | Retrieve a Return to Service Configuration with the supplied id 
*ReturnToServiceAPI* | [**V1ReturnToServiceIdPut**](docs/ReturnToServiceAPI.md#v1returntoserviceidput) | **Put** /v1/return-to-service/{id} | Update a Return to Service Configuration 
*ReturnToServiceAPI* | [**V1ReturnToServicePost**](docs/ReturnToServiceAPI.md#v1returntoservicepost) | **Post** /v1/return-to-service | Create a Return to Service Configuration 
*SchedulerAPI* | [**V1SchedulerJobsGet**](docs/SchedulerAPI.md#v1schedulerjobsget) | **Get** /v1/scheduler/jobs | Retrieve all Jamf Pro Scheduler jobs
*SchedulerAPI* | [**V1SchedulerJobsJobKeyTriggersGet**](docs/SchedulerAPI.md#v1schedulerjobsjobkeytriggersget) | **Get** /v1/scheduler/jobs/{jobKey}/triggers | Retrieve all triggers for a Jamf Pro Scheduler job
*SchedulerAPI* | [**V1SchedulerSummaryGet**](docs/SchedulerAPI.md#v1schedulersummaryget) | **Get** /v1/scheduler/summary | Retrieve a summary of the Jamf Pro Scheduler
...
*SelfServiceAPI* | [**V1SelfServiceSettingsHistoryGet**](docs/SelfServiceAPI.md#v1selfservicesettingshistoryget) | **Get** /v1/self-service/settings/history | Get a page of Self Service settings history 
*SelfServiceAPI* | [**V1SelfServiceSettingsHistoryPost**](docs/SelfServiceAPI.md#v1selfservicesettingshistorypost) | **Post** /v1/self-service/settings/history | Add Self Service settings history notes 
...
*SelfServicePlusAPI* | [**GetSelfServicePlusFeatureToggleEnabled**](docs/SelfServicePlusAPI.md#getselfserviceplusfeaturetoggleenabled) | **Get** /v1/self-service-plus/feature-toggle/enabled | Determines if Self Service Plus feature toggle is enabled.
*SelfServicePlusAPI* | [**GetSelfServicePlusSettings**](docs/SelfServicePlusAPI.md#getselfserviceplussettings) | **Get** /v1/self-service-plus/settings | Get Self Service Plus settings.
*SelfServicePlusAPI* | [**PutSelfServicePlusSettings**](docs/SelfServicePlusAPI.md#putselfserviceplussettings) | **Put** /v1/self-service-plus/settings | Save Self Service Plus settings.
*ServiceDiscoveryEnrollmentAPI* | [**V1ServiceDiscoveryEnrollmentWellKnownSettingsGet**](docs/ServiceDiscoveryEnrollmentAPI.md#v1servicediscoveryenrollmentwellknownsettingsget) | **Get** /v1/service-discovery-enrollment/well-known-settings | Get service discovery well-known settings for all organizations
*ServiceDiscoveryEnrollmentAPI* | [**V1ServiceDiscoveryEnrollmentWellKnownSettingsPut**](docs/ServiceDiscoveryEnrollmentAPI.md#v1servicediscoveryenrollmentwellknownsettingsput) | **Put** /v1/service-discovery-enrollment/well-known-settings | Update service discovery well-known settings
*SitesAPI* | [**V1SitesGet**](docs/SitesAPI.md#v1sitesget) | **Get** /v1/sites | Find all sites 
*SitesAPI* | [**V1SitesIdObjectsGet**](docs/SitesAPI.md#v1sitesidobjectsget) | **Get** /v1/sites/{id}/objects | Find and filter site objects for a site ID 
*SlasaAPI* | [**V1SlasaGet**](docs/SlasaAPI.md#v1slasaget) | **Get** /v1/slasa | Get the status of SLASA
*SlasaAPI* | [**V1SlasaPost**](docs/SlasaAPI.md#v1slasapost) | **Post** /v1/slasa | Accept the SLASA
...
*SmtpServerAPI* | [**V1SmtpServerHistoryGet**](docs/SmtpServerAPI.md#v1smtpserverhistoryget) | **Get** /v1/smtp-server/history | Get specified SMTP Server history object 
*SmtpServerAPI* | [**V1SmtpServerHistoryPost**](docs/SmtpServerAPI.md#v1smtpserverhistorypost) | **Post** /v1/smtp-server/history | Add SMTP Server history object notes 
*SmtpServerAPI* | [**V1SmtpServerTestPost**](docs/SmtpServerAPI.md#v1smtpservertestpost) | **Post** /v1/smtp-server/test | Test functionality of an SMTP Server
*SmtpServerAPI* | [**V2SmtpServerGet**](docs/SmtpServerAPI.md#v2smtpserverget) | **Get** /v2/smtp-server | Finds the Jamf Pro SMTP Server information 
*SmtpServerAPI* | [**V2SmtpServerPut**](docs/SmtpServerAPI.md#v2smtpserverput) | **Put** /v2/smtp-server | Updates Jamf Pro SMTP Server information 
...
*SsoOauthSessionTokensAPI* | [**V1Oauth2SessionTokensGet**](docs/SsoOauthSessionTokensAPI.md#v1oauth2sessiontokensget) | **Get** /v1/oauth2/session-tokens | Retrieve the access token and user information for the current session. 
*SsoSettingsAPI* | [**V3SsoDependenciesGet**](docs/SsoSettingsAPI.md#v3ssodependenciesget) | **Get** /v3/sso/dependencies | Retrieve the list of Enrollment Customizations using SSO 
*SsoSettingsAPI* | [**V3SsoDisablePost**](docs/SsoSettingsAPI.md#v3ssodisablepost) | **Post** /v3/sso/disable | Disable SSO 
*SsoSettingsAPI* | [**V3SsoGet**](docs/SsoSettingsAPI.md#v3ssoget) | **Get** /v3/sso | Retrieve the current Single Sign On configuration settings 
*SsoSettingsAPI* | [**V3SsoHistoryGet**](docs/SsoSettingsAPI.md#v3ssohistoryget) | **Get** /v3/sso/history | Get SSO history object 
*SsoSettingsAPI* | [**V3SsoHistoryPost**](docs/SsoSettingsAPI.md#v3ssohistorypost) | **Post** /v3/sso/history | Add SSO history object notes 
*SsoSettingsAPI* | [**V3SsoMetadataDownloadGet**](docs/SsoSettingsAPI.md#v3ssometadatadownloadget) | **Get** /v3/sso/metadata/download | Download the Jamf Pro SAML metadata file 
*SsoSettingsAPI* | [**V3SsoPut**](docs/SsoSettingsAPI.md#v3ssoput) | **Put** /v3/sso | Updates the current Single Sign On configuration settings 
...
*UserAPI* | [**V1UserChangePasswordPost**](docs/UserAPI.md#v1userchangepasswordpost) | **Post** /v1/user/change-password | Changes the user account password. 
...
*UserSessionsAPI* | [**V1UserSessionsActiveGet**](docs/UserSessionsAPI.md#v1usersessionsactiveget) | **Get** /v1/user-sessions/active | Get active user sessions. 
*UserSessionsAPI* | [**V1UserSessionsCountGet**](docs/UserSessionsAPI.md#v1usersessionscountget) | **Get** /v1/user-sessions/count | Get count of active user sessions. 
*UsersAPI* | [**V1UsersGet**](docs/UsersAPI.md#v1usersget) | **Get** /v1/users | Retrieve users with pagination and filtering
*UsersAPI* | [**V1UsersIdDelete**](docs/UsersAPI.md#v1usersiddelete) | **Delete** /v1/users/{id} | Delete a user from inventory
*UsersAPI* | [**V1UsersIdGet**](docs/UsersAPI.md#v1usersidget) | **Get** /v1/users/{id} | Retrieve a user by ID
*UsersAPI* | [**V1UsersIdPut**](docs/UsersAPI.md#v1usersidput) | **Put** /v1/users/{id} | Update a user in inventory
*UsersAPI* | [**V1UsersPost**](docs/UsersAPI.md#v1userspost) | **Post** /v1/users | Create a new user in inventory
...
*VolumePurchasingSubscriptionsAPI* | [**V1VolumePurchasingSubscriptionsIdHistoryGet**](docs/VolumePurchasingSubscriptionsAPI.md#v1volumepurchasingsubscriptionsidhistoryget) | **Get** /v1/volume-purchasing-subscriptions/{id}/history | Get specified Volume Purchasing Subscription history object 
*VolumePurchasingSubscriptionsAPI* | [**V1VolumePurchasingSubscriptionsIdHistoryPost**](docs/VolumePurchasingSubscriptionsAPI.md#v1volumepurchasingsubscriptionsidhistorypost) | **Post** /v1/volume-purchasing-subscriptions/{id}/history | Add Volume Purchasing Subscription history object notes 
...
## Documentation For Models
 ...
 - [AccessManagementSetting](docs/AccessManagementSetting.md)
 ...
 - [AccountGroupSearchResultsV1](docs/AccountGroupSearchResultsV1.md)
 - [AccountGroupV1](docs/AccountGroupV1.md)
 - [AccountGroupV1MembersInner](docs/AccountGroupV1MembersInner.md)
 - [AccountPreferences](docs/AccountPreferences.md)
 - [AccountPreferencesSearchType](docs/AccountPreferencesSearchType.md)
 - [AccountPreferencesUserInterfaceDisplayTheme](docs/AccountPreferencesUserInterfaceDisplayTheme.md)
 - [AccountPreferencesV1](docs/AccountPreferencesV1.md)
 - [AccountPreferencesV5](docs/AccountPreferencesV5.md)
 - [AccountPreferencesV6](docs/AccountPreferencesV6.md)
 ...
 - [ActiveUserSession](docs/ActiveUserSession.md)
 - [ActiveUsersCount](docs/ActiveUsersCount.md)
 - [AdcsCertificate](docs/AdcsCertificate.md)
 - [AdcsCertificateResponse](docs/AdcsCertificateResponse.md)
 - [AdcsDependencies](docs/AdcsDependencies.md)
 - [AdcsDependency](docs/AdcsDependency.md)
 - [AdcsSettings](docs/AdcsSettings.md)
 - [AdcsSettingsResponse](docs/AdcsSettingsResponse.md)
 ...
 - [ApnsClientPushStatus](docs/ApnsClientPushStatus.md)
 - [ApnsClientPushStatusSearchResults](docs/ApnsClientPushStatusSearchResults.md)
 - [ApnsPushEnableRequest](docs/ApnsPushEnableRequest.md)
 ...
 - [ApplyRedemptionCodeCommand](docs/ApplyRedemptionCodeCommand.md)
 - [AssignRemoveProfileResponseSyncState](docs/AssignRemoveProfileResponseSyncState.md)
 - [Assignment](docs/Assignment.md)
 - [AssignmentDtoV1](docs/AssignmentDtoV1.md)
 ...
 - [BlankPushRequest](docs/BlankPushRequest.md)
 - [BlankPushResponse](docs/BlankPushResponse.md)
 ...
 - [CeaTemplatesResults](docs/CeaTemplatesResults.md)
 ...
 - [CertificateListCommand](docs/CertificateListCommand.md)
 ...
 - [ClearPasscodeCommand](docs/ClearPasscodeCommand.md)
 - [ClearRestrictionsPasswordCommand](docs/ClearRestrictionsPasswordCommand.md)
 - [ClientCheckInV3](docs/ClientCheckInV3.md)
 - [CloudDistributionPoint](docs/CloudDistributionPoint.md)
 - [CloudDistributionPointInventoryFileInfo](docs/CloudDistributionPointInventoryFileInfo.md)
 - [CloudDistributionPointInventoryFilesResults](docs/CloudDistributionPointInventoryFilesResults.md)
 - [CloudDistributionPointTestConnection](docs/CloudDistributionPointTestConnection.md)
 - [CloudDistributionPointUploadCapability](docs/CloudDistributionPointUploadCapability.md)
 ...
 - [ComputerApplicationCreate](docs/ComputerApplicationCreate.md)
 - [ComputerApplicationV3](docs/ComputerApplicationV3.md)
 - [ComputerAttachment](docs/ComputerAttachment.md)
 - [ComputerCertificate](docs/ComputerCertificate.md)
 - [ComputerCertificateCreate](docs/ComputerCertificateCreate.md)
 - [ComputerConfigurationProfile](docs/ComputerConfigurationProfile.md)
 - [ComputerConfigurationProfileCreate](docs/ComputerConfigurationProfileCreate.md)
 ...
 - [ComputerDiskCreate](docs/ComputerDiskCreate.md)
 - [ComputerDiskEncryption](docs/ComputerDiskEncryption.md)
 - [ComputerExtensionAttribute](docs/ComputerExtensionAttribute.md)
 - [ComputerExtensionAttributeSearchResults](docs/ComputerExtensionAttributeSearchResults.md)
 - [ComputerExtensionAttributeTemplates](docs/ComputerExtensionAttributeTemplates.md)
 - [ComputerExtensionAttributes](docs/ComputerExtensionAttributes.md)
 - [ComputerFont](docs/ComputerFont.md)
 - [ComputerFontCreate](docs/ComputerFontCreate.md)
 - [ComputerGeneral](docs/ComputerGeneral.md)
 - [ComputerGeneralCreate](docs/ComputerGeneralCreate.md)
 ...
 - [ComputerHardwareCreate](docs/ComputerHardwareCreate.md)
 ...
 - [ComputerInventoryCollectionPreferencesV2](docs/ComputerInventoryCollectionPreferencesV2.md)
 - [ComputerInventoryCollectionSettings](docs/ComputerInventoryCollectionSettings.md)
 - [ComputerInventoryCollectionSettingsV2](docs/ComputerInventoryCollectionSettingsV2.md)
 - [ComputerInventoryCreateRequest](docs/ComputerInventoryCreateRequest.md)
 - [ComputerInventoryCreateRequestV2](docs/ComputerInventoryCreateRequestV2.md)
 - [ComputerInventoryDeviceLockPinResponse](docs/ComputerInventoryDeviceLockPinResponse.md)
 ...
 - [ComputerInventorySearchResultsV2](docs/ComputerInventorySearchResultsV2.md)
 - [ComputerInventorySearchResultsV3](docs/ComputerInventorySearchResultsV3.md)
 - [ComputerInventoryUpdateRequest](docs/ComputerInventoryUpdateRequest.md)
 - [ComputerInventoryV2](docs/ComputerInventoryV2.md)
 - [ComputerInventoryV3](docs/ComputerInventoryV3.md)
 - [ComputerLicensedSoftware](docs/ComputerLicensedSoftware.md)
 - [ComputerLocalUserAccount](docs/ComputerLocalUserAccount.md)
 - [ComputerLocalUserAccountCreate](docs/ComputerLocalUserAccountCreate.md)
 ...
 - [ComputerOperatingSystemCreate](docs/ComputerOperatingSystemCreate.md)
 ...
 - [ComputerPackageReceiptsCreate](docs/ComputerPackageReceiptsCreate.md)
 - [ComputerPartition](docs/ComputerPartition.md)
 - [ComputerPartitionCreate](docs/ComputerPartitionCreate.md)
 ...
 - [ComputerPrinterCreate](docs/ComputerPrinterCreate.md)
 - [ComputerPurchase](docs/ComputerPurchase.md)
 - [ComputerPurchaseCreate](docs/ComputerPurchaseCreate.md)
 - [ComputerRemoteManagement](docs/ComputerRemoteManagement.md)
 - [ComputerRemoteManagementCreate](docs/ComputerRemoteManagementCreate.md)
 - [ComputerSection](docs/ComputerSection.md)
 - [ComputerSectionV2](docs/ComputerSectionV2.md)
 - [ComputerSectionV3](docs/ComputerSectionV3.md)
 - [ComputerSecurity](docs/ComputerSecurity.md)
 - [ComputerSecurityCreate](docs/ComputerSecurityCreate.md)
 - [ComputerService](docs/ComputerService.md)
 - [ComputerServiceCreate](docs/ComputerServiceCreate.md)
 - [ComputerSoftwareUpdate](docs/ComputerSoftwareUpdate.md)
 - [ComputerSoftwareUpdateCreate](docs/ComputerSoftwareUpdateCreate.md)
 - [ComputerStorage](docs/ComputerStorage.md)
 - [ComputerStorageCreate](docs/ComputerStorageCreate.md)
 - [ComputerUserAndLocation](docs/ComputerUserAndLocation.md)
 - [ComputerUserAndLocationCreate](docs/ComputerUserAndLocationCreate.md)
 - [ComputerUserManagementInfo](docs/ComputerUserManagementInfo.md)
 ...
 - [CreatePathV2](docs/CreatePathV2.md)
 - [Credentials](docs/Credentials.md)
 - [CsaTenantIdInfo](docs/CsaTenantIdInfo.md)
 ...
 - [DashboardObject](docs/DashboardObject.md)
 ...
 - [DefaultApplications](docs/DefaultApplications.md)
 - [DeleteUserCommand](docs/DeleteUserCommand.md)
 - [Department](docs/Department.md)
 - [DepartmentsSearchResults](docs/DepartmentsSearchResults.md)
 - [DependencyObjectResults](docs/DependencyObjectResults.md)
 - [DependencyObjectResultsResultsInner](docs/DependencyObjectResultsResultsInner.md)
 - [DeploymentTask](docs/DeploymentTask.md)
 - [DeploymentTaskSearchResults](docs/DeploymentTaskSearchResults.md)
 - [DetailsV2](docs/DetailsV2.md)
 - [DeviceCommonDetails](docs/DeviceCommonDetails.md)
 - [DeviceCommonDetailsRequest](docs/DeviceCommonDetailsRequest.md)
 ...
 - [DeviceEnrollmentPrestageV3](docs/DeviceEnrollmentPrestageV3.md)
 - [DeviceEnrollmentToken](docs/DeviceEnrollmentToken.md)
 - [DeviceGroup](docs/DeviceGroup.md)
 - [DeviceInformationCommand](docs/DeviceInformationCommand.md)
 - [DeviceLocationCommand](docs/DeviceLocationCommand.md)
 - [DeviceLockCommand](docs/DeviceLockCommand.md)
 - [DiagnosticSubmissionSetting](docs/DiagnosticSubmissionSetting.md)
 - [DigiCertSetting](docs/DigiCertSetting.md)
 - [DigiCertSettingResponse](docs/DigiCertSettingResponse.md)
 - [DigicertConnectionStatus](docs/DigicertConnectionStatus.md)
 - [DigicertDependencies](docs/DigicertDependencies.md)
 - [DigicertDependency](docs/DigicertDependency.md)
 - [DisableLostModeCommand](docs/DisableLostModeCommand.md)
 - [DisableRemoteDesktopCommand](docs/DisableRemoteDesktopCommand.md)
 - [DistributionPoint](docs/DistributionPoint.md)
 - [DistributionPointSearchResults](docs/DistributionPointSearchResults.md)
 - [DockItem](docs/DockItem.md)
 - [DownloadUrl](docs/DownloadUrl.md)
 - [DssDeclaration](docs/DssDeclaration.md)
 - [DssDeclarations](docs/DssDeclarations.md)
 - [Ebook](docs/Ebook.md)
 ...
 - [EnablePushRequest](docs/EnablePushRequest.md)
 - [EnableRemoteDesktopCommand](docs/EnableRemoteDesktopCommand.md)
 ...
 - [EnrollmentSettingsV4](docs/EnrollmentSettingsV4.md)
 - [EnrollmentSsoConfig](docs/EnrollmentSsoConfig.md)
 - [EraseDeviceCommand](docs/EraseDeviceCommand.md)
 - [EraseDeviceComputerRequest](docs/EraseDeviceComputerRequest.md)
 - [EraseDeviceComputerResponse](docs/EraseDeviceComputerResponse.md)
 - [EraseDeviceMobileDeviceRequest](docs/EraseDeviceMobileDeviceRequest.md)
 - [EraseDeviceMobileDeviceResponse](docs/EraseDeviceMobileDeviceResponse.md)
 ...
 - [ExtensionAttributeValue](docs/ExtensionAttributeValue.md)
 - [ExtensionAttributes](docs/ExtensionAttributes.md)
 - [ExternalRecipient](docs/ExternalRecipient.md)
 - [FileAttachmentV2](docs/FileAttachmentV2.md)
 - [FileAttachmentV3](docs/FileAttachmentV3.md)
 - [FileData](docs/FileData.md)
 - [FileTransferItem](docs/FileTransferItem.md)
 ...
 - [GetMobileDevicePrestageV3](docs/GetMobileDevicePrestageV3.md)
 - [GroupDtoV1](docs/GroupDtoV1.md)
 - [GroupMappings](docs/GroupMappings.md)
 - [GroupMembership](docs/GroupMembership.md)
 - [GroupResetRequest](docs/GroupResetRequest.md)
 ...
 - [GroupUpdateDtoV1](docs/GroupUpdateDtoV1.md)
 - [GroupWithCriteriaDtoV1](docs/GroupWithCriteriaDtoV1.md)
 - [GsxConnection](docs/GsxConnection.md)
 - [GsxConnectionUpdate](docs/GsxConnectionUpdate.md)
 - [GsxKeystore](docs/GsxKeystore.md)
 - [GsxTestResponse](docs/GsxTestResponse.md)
 - [HealthStatus](docs/HealthStatus.md)
 - [HealthStatusStats](docs/HealthStatusStats.md)
 ...
 - [Ids](docs/Ids.md)
 - [ImpactAlertNotificationSettingsV1](docs/ImpactAlertNotificationSettingsV1.md)
 - [InitializeV1](docs/InitializeV1.md)
 - [InstallPackage](docs/InstallPackage.md)
 - [InstalledApplicationListCommand](docs/InstalledApplicationListCommand.md)
 ...
 - [LapsAccountManagementHistory](docs/LapsAccountManagementHistory.md)
 - [LapsAccountManagementHistoryResponse](docs/LapsAccountManagementHistoryResponse.md)
 ...
 - [LastLoginResponse](docs/LastLoginResponse.md)
 ...
 - [LocationInformationV3](docs/LocationInformationV3.md)
 - [LocationV2](docs/LocationV2.md)
 - [LogFlushingTaskV1](docs/LogFlushingTaskV1.md)
 - [LogFlushingV1](docs/LogFlushingV1.md)
 - [LogOutUserCommand](docs/LogOutUserCommand.md)
 - [LoginContent](docs/LoginContent.md)
 - [LoginContentPut](docs/LoginContentPut.md)
 ...
 - [ManagedApplicationListCommand](docs/ManagedApplicationListCommand.md)
 - [ManagedMediaListCommand](docs/ManagedMediaListCommand.md)
 - [ManagedSoftwareUpdatePlan](docs/ManagedSoftwareUpdatePlan.md)
 - [ManagedSoftwareUpdatePlanEventStore](docs/ManagedSoftwareUpdatePlanEventStore.md)
 ...
 - [ManagedSoftwareUpdatePlanToggleStatus](docs/ManagedSoftwareUpdatePlanToggleStatus.md)
 - [ManagedSoftwareUpdatePlanToggleStatusWrapper](docs/ManagedSoftwareUpdatePlanToggleStatusWrapper.md)
 ...
 - [MdmRenewalError](docs/MdmRenewalError.md)
 - [MdmRenewalErrorStrategiesResponse](docs/MdmRenewalErrorStrategiesResponse.md)
 - [MdmRenewalErrorType](docs/MdmRenewalErrorType.md)
 - [MdmRenewalStrategy](docs/MdmRenewalStrategy.md)
 - [MdmRenewalStrategyType](docs/MdmRenewalStrategyType.md)
 ...
 - [MobileDeviceExtensionAttributeSearchResults](docs/MobileDeviceExtensionAttributeSearchResults.md)
 - [MobileDeviceExtensionAttributes](docs/MobileDeviceExtensionAttributes.md)
 ...
 - [MobileDeviceInventoryGroup](docs/MobileDeviceInventoryGroup.md)
 ...
 - [MobileDeviceMdmCapableUser](docs/MobileDeviceMdmCapableUser.md)
 - [MobileDeviceNetwork](docs/MobileDeviceNetwork.md)
 - [MobileDevicePrestageNameV2](docs/MobileDevicePrestageNameV2.md)
 - [MobileDevicePrestageNameV3](docs/MobileDevicePrestageNameV3.md)
 - [MobileDevicePrestageNamesV2](docs/MobileDevicePrestageNamesV2.md)
 - [MobileDevicePrestageNamesV3](docs/MobileDevicePrestageNamesV3.md)
 - [MobileDevicePrestageSearchResultsV2](docs/MobileDevicePrestageSearchResultsV2.md)
 - [MobileDevicePrestageSearchResultsV3](docs/MobileDevicePrestageSearchResultsV3.md)
 - [MobileDevicePrestageV2](docs/MobileDevicePrestageV2.md)
 - [MobileDevicePrestageV3](docs/MobileDevicePrestageV3.md)
 ...
 - [MobileDeviceWatchOsGeneral](docs/MobileDeviceWatchOsGeneral.md)
 - [MobileDeviceWatchOsInventory](docs/MobileDeviceWatchOsInventory.md)
 ...
 - [OAuthTokenEndpointErrorResponse](docs/OAuthTokenEndpointErrorResponse.md)
 - [OAuthTokenResponse](docs/OAuthTokenResponse.md)
 - [OauthTokens](docs/OauthTokens.md)
 - [ObjectHistory](docs/ObjectHistory.md)
 - [ObjectHistoryNote](docs/ObjectHistoryNote.md)
 - [ObjectHistoryV1](docs/ObjectHistoryV1.md)
 - [OidcDirectIdpLoginSkipUrl](docs/OidcDirectIdpLoginSkipUrl.md)
 - [OidcJwksResponse](docs/OidcJwksResponse.md)
 - [OidcJwksResponseKeysInner](docs/OidcJwksResponseKeysInner.md)
 - [OidcLoginDispatchRequest](docs/OidcLoginDispatchRequest.md)
 - [OidcLoginDispatchResponse](docs/OidcLoginDispatchResponse.md)
 - [OidcLoginDispatchResponseV2](docs/OidcLoginDispatchResponseV2.md)
 - [OidcLoginDispatchResponseV2IdpRedirectsInner](docs/OidcLoginDispatchResponseV2IdpRedirectsInner.md)
 - [OidcPublicFeaturesResponse](docs/OidcPublicFeaturesResponse.md)
 - [OidcSettings](docs/OidcSettings.md)
 - [OnboardingConfiguration](docs/OnboardingConfiguration.md)
 - [OnboardingEligibleItem](docs/OnboardingEligibleItem.md)
 - [OnboardingEligibleItemsSearchResult](docs/OnboardingEligibleItemsSearchResult.md)
 ...
 - [PackagesSearchResults](docs/PackagesSearchResults.md)
 - [PagedUserResults](docs/PagedUserResults.md)
 ...
 - [PlatformInitializeV1](docs/PlatformInitializeV1.md)
 - [PlayLostModeSoundCommand](docs/PlayLostModeSoundCommand.md)
 ...
 - [PrestageFileAttachmentV3](docs/PrestageFileAttachmentV3.md)
 - [PrestagePurchasingInformationV2](docs/PrestagePurchasingInformationV2.md)
 - [PrestagePurchasingInformationV3](docs/PrestagePurchasingInformationV3.md)
 ...
 - [ProfileListCommand](docs/ProfileListCommand.md)
 ...
 - [ProvisioningProfileListCommand](docs/ProvisioningProfileListCommand.md)
 ...
 - [PutMobileDevicePrestageV3](docs/PutMobileDevicePrestageV3.md)
 ...
 - [RefreshCellularPlansCommand](docs/RefreshCellularPlansCommand.md)
 ...
 - [RemoveComputerMdmProfileResponse](docs/RemoveComputerMdmProfileResponse.md)
 - [RenewMdmProfileResponse](docs/RenewMdmProfileResponse.md)
 - [RequestMirroringCommand](docs/RequestMirroringCommand.md)
 - [RestartDeviceCommand](docs/RestartDeviceCommand.md)
 - [RetentionPolicyV1](docs/RetentionPolicyV1.md)
 - [ReturnToService](docs/ReturnToService.md)
 - [ReturnToServiceConfiguration](docs/ReturnToServiceConfiguration.md)
 - [ReturnToServiceConfigurationRequest](docs/ReturnToServiceConfigurationRequest.md)
 - [ReturnToServiceConfigurationSearchResults](docs/ReturnToServiceConfigurationSearchResults.md)
 - [SafelistedApp](docs/SafelistedApp.md)
 - [SamlSettings](docs/SamlSettings.md)
 - [SchedulerJob](docs/SchedulerJob.md)
 - [SchedulerJobs](docs/SchedulerJobs.md)
 - [SchedulerSummary](docs/SchedulerSummary.md)
 - [SchedulerTrigger](docs/SchedulerTrigger.md)
 - [Script](docs/Script.md)
 - [ScriptsSearchResults](docs/ScriptsSearchResults.md)
 - [SecurityInfoCommand](docs/SecurityInfoCommand.md)
 ...
 - [SelfServicePlusSettings](docs/SelfServicePlusSettings.md)
 - [SelfServiceSettings](docs/SelfServiceSettings.md)
 - [ServiceDiscoveryVersion](docs/ServiceDiscoveryVersion.md)
 ...
 - [SessionHistoryItemDetails](docs/SessionHistoryItemDetails.md)
 - [SessionHistoryItemWithDetails](docs/SessionHistoryItemWithDetails.md)
 - [SessionHistorySearchResults](docs/SessionHistorySearchResults.md)
 ...
 - [SharedDeviceComplianceFeatureToggle](docs/SharedDeviceComplianceFeatureToggle.md)
 - [SharedDeviceConfiguration](docs/SharedDeviceConfiguration.md)
 - [ShutDownDeviceCommand](docs/ShutDownDeviceCommand.md)
 - [Signature](docs/Signature.md)
 - [Site](docs/Site.md)
 - [SiteObject](docs/SiteObject.md)
 - [SlasaAcceptance](docs/SlasaAcceptance.md)
 - [SmartComputerGroupSearch](docs/SmartComputerGroupSearch.md)
 - [SmartComputerGroupV2](docs/SmartComputerGroupV2.md)
 - [SmartGroup](docs/SmartGroup.md)
 - [SmartGroupAssignment](docs/SmartGroupAssignment.md)
 - [SmartGroupCriteria](docs/SmartGroupCriteria.md)
 - [SmartGroupDetail](docs/SmartGroupDetail.md)
 - [SmartGroupMembership](docs/SmartGroupMembership.md)
 - [SmartGroupSearchResult](docs/SmartGroupSearchResult.md)
 - [SmartGroupSearchResults](docs/SmartGroupSearchResults.md)
 - [SmartSearchCriterion](docs/SmartSearchCriterion.md)
 - [SmtpBasicCredentials](docs/SmtpBasicCredentials.md)
 - [SmtpConnectionSettings](docs/SmtpConnectionSettings.md)
 - [SmtpGoogleMailAuthentication](docs/SmtpGoogleMailAuthentication.md)
 - [SmtpGoogleMailCredentials](docs/SmtpGoogleMailCredentials.md)
 - [SmtpGraphApiCredentials](docs/SmtpGraphApiCredentials.md)
 - [SmtpSenderSettings](docs/SmtpSenderSettings.md)
 - [SmtpServerTest](docs/SmtpServerTest.md)
 - [SmtpServerV2](docs/SmtpServerV2.md)
 ...
 - [SsoSettingsV3](docs/SsoSettingsV3.md)
 - [StartupStatus](docs/StartupStatus.md)
 - [StaticComputerGroup](docs/StaticComputerGroup.md)
 - [StaticComputerGroupAssignment](docs/StaticComputerGroupAssignment.md)
 - [StaticComputerGroupSearchResults](docs/StaticComputerGroupSearchResults.md)
 - [StaticComputerGroupSummary](docs/StaticComputerGroupSummary.md)
 ...
 - [StopMirroringCommand](docs/StopMirroringCommand.md)
 ...
 - [Udids](docs/Udids.md)
 - [UnlockUserAccountCommand](docs/UnlockUserAccountCommand.md)
 - [UnmanageMobileDeviceResponse](docs/UnmanageMobileDeviceResponse.md)
 ...
 - [UserAccountSearchResults](docs/UserAccountSearchResults.md)
 ...
 - [V1SiteBase](docs/V1SiteBase.md)
 - [ValidateApplicationsCommand](docs/ValidateApplicationsCommand.md)
 ...
 - [VerifyRecoveryLockCommand](docs/VerifyRecoveryLockCommand.md)
 ...
 - [WatchOsDetailsV2](docs/WatchOsDetailsV2.md)
 - [WebLink](docs/WebLink.md)
 - [WellKnownSetting](docs/WellKnownSetting.md)
 - [WellKnownSettingsRequest](docs/WellKnownSettingsRequest.md)
 - [WellKnownSettingsResponse](docs/WellKnownSettingsResponse.md)
