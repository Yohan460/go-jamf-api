...
// checks if the ClientCheckInV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientCheckInV3{}
...
func (o ClientCheckInV3) ToMap() (map[string]interface{}, error) {
