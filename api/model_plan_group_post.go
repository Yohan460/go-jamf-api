...
type _PlanGroupPost PlanGroupPost
...
func (o *PlanGroupPost) UnmarshalJSON(data []byte) (err error) {
	...
	varPlanGroupPost := _PlanGroupPost{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlanGroupPost)

	if err != nil {
		return err
	}

	*o = PlanGroupPost(varPlanGroupPost)
