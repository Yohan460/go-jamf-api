...
type _UserMappings UserMappings
...
func (o *UserMappings) UnmarshalJSON(data []byte) (err error) {
	...
	varUserMappings := _UserMappings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserMappings)

	if err != nil {
		return err
	}

	*o = UserMappings(varUserMappings)
