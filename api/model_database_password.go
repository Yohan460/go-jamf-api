...
// checks if the DatabasePassword type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabasePassword{}
...
type _DatabasePassword DatabasePassword
...
func (o DatabasePassword) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["password"] = o.Password
	return toSerialize, nil
}

func (o *DatabasePassword) UnmarshalJSON(data []byte) (err error) {
	...
	varDatabasePassword := _DatabasePassword{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDatabasePassword)

	if err != nil {
		return err
	}

	*o = DatabasePassword(varDatabasePassword)
