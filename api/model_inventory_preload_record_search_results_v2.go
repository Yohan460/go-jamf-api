...
func NewInventoryPreloadRecordSearchResultsV2() *InventoryPreloadRecordSearchResultsV2 {
	this := InventoryPreloadRecordSearchResultsV2{}
	return &this
}
...
// SetResults gets a reference to the given []InventoryPreloadRecordV2 and assigns it to the Results field.
...
type NullableInventoryPreloadRecordSearchResultsV2 struct {
	value *InventoryPreloadRecordSearchResultsV2
	isSet bool
}

func (v NullableInventoryPreloadRecordSearchResultsV2) Get() *InventoryPreloadRecordSearchResultsV2 {
	return v.value
}

func (v *NullableInventoryPreloadRecordSearchResultsV2) Set(val *InventoryPreloadRecordSearchResultsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryPreloadRecordSearchResultsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryPreloadRecordSearchResultsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryPreloadRecordSearchResultsV2(val *InventoryPreloadRecordSearchResultsV2) *NullableInventoryPreloadRecordSearchResultsV2 {
	return &NullableInventoryPreloadRecordSearchResultsV2{value: val, isSet: true}
}

func (v NullableInventoryPreloadRecordSearchResultsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryPreloadRecordSearchResultsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
