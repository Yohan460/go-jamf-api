...
type _MembershipTestSearchRequest MembershipTestSearchRequest
...
func (o *MembershipTestSearchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varMembershipTestSearchRequest := _MembershipTestSearchRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMembershipTestSearchRequest)

	if err != nil {
		return err
	}

	*o = MembershipTestSearchRequest(varMembershipTestSearchRequest)
