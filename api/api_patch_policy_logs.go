...
func (r PatchPolicyLogsAPIV2PatchPoliciesIdLogsGetRequest) Page(page int64) PatchPolicyLogsAPIV2PatchPoliciesIdLogsGetRequest {
	r.page = &page
	return r
}

func (r PatchPolicyLogsAPIV2PatchPoliciesIdLogsGetRequest) PageSize(pageSize int64) PatchPolicyLogsAPIV2PatchPoliciesIdLogsGetRequest {
	r.pageSize = &pageSize
	return r
}
...
func (a *PatchPolicyLogsAPIService) V2PatchPoliciesIdLogsGetExecute(r PatchPolicyLogsAPIV2PatchPoliciesIdLogsGetRequest) (*PatchPolicyLogs, *http.Response, error) {
	...
	if r.sort != nil {
		...
		var defaultValue []string = []string{"deviceName:asc"}
