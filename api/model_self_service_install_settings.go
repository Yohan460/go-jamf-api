...
type _SelfServiceInstallSettings SelfServiceInstallSettings
...
func (o *SelfServiceInstallSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varSelfServiceInstallSettings := _SelfServiceInstallSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSelfServiceInstallSettings)

	if err != nil {
		return err
	}

	*o = SelfServiceInstallSettings(varSelfServiceInstallSettings)
