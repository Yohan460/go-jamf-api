...
type _SelfServiceLoginSettings SelfServiceLoginSettings
...
func (o *SelfServiceLoginSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varSelfServiceLoginSettings := _SelfServiceLoginSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSelfServiceLoginSettings)

	if err != nil {
		return err
	}

	*o = SelfServiceLoginSettings(varSelfServiceLoginSettings)
