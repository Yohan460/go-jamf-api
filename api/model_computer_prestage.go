...
func (o ComputerPrestage) MarshalJSON() ([]byte, error) {
...
type NullableComputerPrestage struct {
	value *ComputerPrestage
	isSet bool
}

func (v NullableComputerPrestage) Get() *ComputerPrestage {
	return v.value
}

func (v *NullableComputerPrestage) Set(val *ComputerPrestage) {
	v.value = val
	v.isSet = true
}

func (v NullableComputerPrestage) IsSet() bool {
	return v.isSet
}

func (v *NullableComputerPrestage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputerPrestage(val *ComputerPrestage) *NullableComputerPrestage {
	return &NullableComputerPrestage{value: val, isSet: true}
}

func (v NullableComputerPrestage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputerPrestage) UnmarshalJSON(src []byte) error {
	v.isSet = true
