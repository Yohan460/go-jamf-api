...
func (r EbooksAPIV1EbooksGetRequest) Page(page int64) EbooksAPIV1EbooksGetRequest {
	r.page = &page
	return r
}

func (r EbooksAPIV1EbooksGetRequest) PageSize(pageSize int64) EbooksAPIV1EbooksGetRequest {
	r.pageSize = &pageSize
	return r
}
