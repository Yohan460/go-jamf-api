...
type _OAuthClientCredentials OAuthClientCredentials
...
func (o *OAuthClientCredentials) UnmarshalJSON(data []byte) (err error) {
	...
	varOAuthClientCredentials := _OAuthClientCredentials{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOAuthClientCredentials)

	if err != nil {
		return err
	}

	*o = OAuthClientCredentials(varOAuthClientCredentials)
