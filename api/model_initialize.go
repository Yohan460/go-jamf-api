...
func (o *Initialize) UnmarshalJSON(data []byte) (err error) {
	...
	varInitialize := _Initialize{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInitialize)

	if err != nil {
		return err
	}

	*o = Initialize(varInitialize)
