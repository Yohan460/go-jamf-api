...
// checks if the ComputerInventoryCollectionPreferencesV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputerInventoryCollectionPreferencesV2{}

// ComputerInventoryCollectionPreferencesV2 struct for ComputerInventoryCollectionPreferencesV2
...
func NewComputerInventoryCollectionPreferencesV2() *ComputerInventoryCollectionPreferencesV2 {
	this := ComputerInventoryCollectionPreferencesV2{}
...
func (o ComputerInventoryCollectionPreferencesV2) MarshalJSON() ([]byte, error) {
...
func (o ComputerInventoryCollectionPreferencesV2) ToMap() (map[string]interface{}, error) {
...
type NullableComputerInventoryCollectionPreferencesV2 struct {
	value *ComputerInventoryCollectionPreferencesV2
	isSet bool
}

func (v NullableComputerInventoryCollectionPreferencesV2) Get() *ComputerInventoryCollectionPreferencesV2 {
	return v.value
}

func (v *NullableComputerInventoryCollectionPreferencesV2) Set(val *ComputerInventoryCollectionPreferencesV2) {
	v.value = val
	v.isSet = true
}

func (v NullableComputerInventoryCollectionPreferencesV2) IsSet() bool {
	return v.isSet
}

func (v *NullableComputerInventoryCollectionPreferencesV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputerInventoryCollectionPreferencesV2(val *ComputerInventoryCollectionPreferencesV2) *NullableComputerInventoryCollectionPreferencesV2 {
	return &NullableComputerInventoryCollectionPreferencesV2{value: val, isSet: true}
}

func (v NullableComputerInventoryCollectionPreferencesV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputerInventoryCollectionPreferencesV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
