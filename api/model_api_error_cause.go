...
type _ApiErrorCause ApiErrorCause
...
func (o *ApiErrorCause) UnmarshalJSON(data []byte) (err error) {
	...
	varApiErrorCause := _ApiErrorCause{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiErrorCause)

	if err != nil {
		return err
	}

	*o = ApiErrorCause(varApiErrorCause)
