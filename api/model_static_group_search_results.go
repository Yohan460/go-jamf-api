...
// checks if the StaticGroupSearchResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticGroupSearchResults{}
...
func (o StaticGroupSearchResults) MarshalJSON() ([]byte, error) {
...
func (o StaticGroupSearchResults) ToMap() (map[string]interface{}, error) {
...
type NullableStaticGroupSearchResults struct {
	value *StaticGroupSearchResults
	isSet bool
}

func (v NullableStaticGroupSearchResults) Get() *StaticGroupSearchResults {
	return v.value
}

func (v *NullableStaticGroupSearchResults) Set(val *StaticGroupSearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticGroupSearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticGroupSearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticGroupSearchResults(val *StaticGroupSearchResults) *NullableStaticGroupSearchResults {
	return &NullableStaticGroupSearchResults{value: val, isSet: true}
}

func (v NullableStaticGroupSearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticGroupSearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
