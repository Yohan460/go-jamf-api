...
// checks if the ComputerInventoryV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputerInventoryV3{}

// ComputerInventoryV3 struct for ComputerInventoryV3
type ComputerInventoryV3 struct {
	...
	Applications []ComputerApplicationV3 `json:"applications,omitempty"`
...
// SetApplications gets a reference to the given []ComputerApplicationV3 and assigns it to the Applications field.
...
func (o ComputerInventoryV3) MarshalJSON() ([]byte, error) {
...
func (o ComputerInventoryV3) ToMap() (map[string]interface{}, error) {
...
type NullableComputerInventoryV3 struct {
	value *ComputerInventoryV3
	isSet bool
}

func (v NullableComputerInventoryV3) Get() *ComputerInventoryV3 {
	return v.value
}

func (v *NullableComputerInventoryV3) Set(val *ComputerInventoryV3) {
	v.value = val
	v.isSet = true
}

func (v NullableComputerInventoryV3) IsSet() bool {
	return v.isSet
}

func (v *NullableComputerInventoryV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputerInventoryV3(val *ComputerInventoryV3) *NullableComputerInventoryV3 {
	return &NullableComputerInventoryV3{value: val, isSet: true}
}

func (v NullableComputerInventoryV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputerInventoryV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
