...
// checks if the ComputerPrestageV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputerPrestageV2{}
...
type _ComputerPrestageV2 ComputerPrestageV2
...
func (o ComputerPrestageV2) MarshalJSON() ([]byte, error) {
...
func (o ComputerPrestageV2) ToMap() (map[string]interface{}, error) {
...
func (o *ComputerPrestageV2) UnmarshalJSON(data []byte) (err error) {
	...
	varComputerPrestageV2 := _ComputerPrestageV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComputerPrestageV2)

	if err != nil {
		return err
	}

	*o = ComputerPrestageV2(varComputerPrestageV2)

	return err
}

type NullableComputerPrestageV2 struct {
	value *ComputerPrestageV2
	isSet bool
}

func (v NullableComputerPrestageV2) Get() *ComputerPrestageV2 {
	return v.value
}

func (v *NullableComputerPrestageV2) Set(val *ComputerPrestageV2) {
	v.value = val
	v.isSet = true
}

func (v NullableComputerPrestageV2) IsSet() bool {
	return v.isSet
}

func (v *NullableComputerPrestageV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputerPrestageV2(val *ComputerPrestageV2) *NullableComputerPrestageV2 {
	return &NullableComputerPrestageV2{value: val, isSet: true}
}

func (v NullableComputerPrestageV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputerPrestageV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
