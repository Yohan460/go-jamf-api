...
const (
	...
	NOTIFICATIONTYPE_DIRECTORY_CACHE_AWAITING_SYNC NotificationType = "DIRECTORY_CACHE_AWAITING_SYNC"
	NOTIFICATIONTYPE_PSSO_EXTERNAL_URL_UNAVAILABLE NotificationType = "PSSO_EXTERNAL_URL_UNAVAILABLE"
)
