...
// checks if the VolumePurchasingSubscriptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumePurchasingSubscriptions{}
...
func (o VolumePurchasingSubscriptions) ToMap() (map[string]interface{}, error) {
