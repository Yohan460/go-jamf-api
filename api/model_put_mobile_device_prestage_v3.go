...
// checks if the PutMobileDevicePrestageV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutMobileDevicePrestageV3{}

// PutMobileDevicePrestageV3 struct for PutMobileDevicePrestageV3
...
type _PutMobileDevicePrestageV3 PutMobileDevicePrestageV3
...
func NewPutMobileDevicePrestageV3(displayName string, mandatory bool, mdmRemovable bool, supportPhoneNumber string, supportEmailAddress string, department string, defaultPrestage bool, enrollmentSiteId string, keepExistingSiteMembership bool, keepExistingLocationInformation bool, requireAuthentication bool, authenticationPrompt string, preventActivationLock bool, enableDeviceBasedActivationLock bool, deviceEnrollmentProgramInstanceId string, locationInformation LocationInformationV3, purchasingInformation PrestagePurchasingInformationV3, autoAdvanceSetup bool, allowPairing bool, multiUser bool, supervised bool, maximumSharedAccounts int64, configureDeviceBeforeSetupAssistant bool, sendTimezone bool, timezone string, storageQuotaSizeMegabytes int64, useStorageQuotaSize bool) *PutMobileDevicePrestageV3 {
	this := PutMobileDevicePrestageV3{}
...
func (o PutMobileDevicePrestageV3) MarshalJSON() ([]byte, error) {
...
func (o PutMobileDevicePrestageV3) ToMap() (map[string]interface{}, error) {
...
func (o *PutMobileDevicePrestageV3) UnmarshalJSON(data []byte) (err error) {
	...
	varPutMobileDevicePrestageV3 := _PutMobileDevicePrestageV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutMobileDevicePrestageV3)

	if err != nil {
		return err
	}

	*o = PutMobileDevicePrestageV3(varPutMobileDevicePrestageV3)

	return err
}

type NullablePutMobileDevicePrestageV3 struct {
	value *PutMobileDevicePrestageV3
	isSet bool
}

func (v NullablePutMobileDevicePrestageV3) Get() *PutMobileDevicePrestageV3 {
	return v.value
}

func (v *NullablePutMobileDevicePrestageV3) Set(val *PutMobileDevicePrestageV3) {
	v.value = val
	v.isSet = true
}

func (v NullablePutMobileDevicePrestageV3) IsSet() bool {
	return v.isSet
}

func (v *NullablePutMobileDevicePrestageV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutMobileDevicePrestageV3(val *PutMobileDevicePrestageV3) *NullablePutMobileDevicePrestageV3 {
	return &NullablePutMobileDevicePrestageV3{value: val, isSet: true}
}

func (v NullablePutMobileDevicePrestageV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutMobileDevicePrestageV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
