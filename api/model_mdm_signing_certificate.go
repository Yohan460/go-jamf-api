...
func NewMdmSigningCertificate() *MdmSigningCertificate {
	this := MdmSigningCertificate{}
	var filename string = ""
	this.Filename = &filename
	var keystorePassword string = ""
	this.KeystorePassword = &keystorePassword
	var identityKeystore string = ""
...
func (o MdmSigningCertificate) MarshalJSON() ([]byte, error) {
...
type NullableMdmSigningCertificate struct {
	value *MdmSigningCertificate
	isSet bool
}

func (v NullableMdmSigningCertificate) Get() *MdmSigningCertificate {
	return v.value
}

func (v *NullableMdmSigningCertificate) Set(val *MdmSigningCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableMdmSigningCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableMdmSigningCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMdmSigningCertificate(val *MdmSigningCertificate) *NullableMdmSigningCertificate {
	return &NullableMdmSigningCertificate{value: val, isSet: true}
}

func (v NullableMdmSigningCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMdmSigningCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
