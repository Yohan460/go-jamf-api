...
// checks if the UpdateAppleTv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAppleTv{}
...
func (o UpdateAppleTv) ToMap() (map[string]interface{}, error) {
